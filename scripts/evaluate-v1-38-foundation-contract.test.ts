...
const PLAN_262_32_A5_COMMIT = "243c9340bc7afea89c10f21b7c0e89423249826f"
const PLAN_262_32_A5_TREE = "3e9009b6e1a6b2b3d0c699ef8449db9b77052661"
const PLAN_262_32_A5_PARENT = "4d915e4039a1a574043d57887136a1602f19046b"
const PLAN_262_32_SOURCE_BASE5 = "1cd79971145eff892f49aad928642b0d875fef53"
const PLAN_262_32_FOCUSED_TEST_FULL_NAMES = ["v1.38 pre-live post-live child protocol compatibility > post-live accepts the exact terminal-selected stopped row","v1.38 plan 262-15 terminal artifact presence > plan 262-15 terminal enforces seal_refused artifact presence","v1.38 plan 262-15 terminal artifact presence > plan 262-15 terminal enforces seal_failed artifact presence","v1.38 plan 262-15 terminal artifact presence > plan 262-15 terminal enforces sealed artifact presence","v1.38 plan 262-16 terminal artifact presence > plan 262-16 terminal validates the preflight-refused charged branch","v1.38 immutable receipt publication > reports cleanup-fsync failure without removing the canonical link","v1.38 immutable receipt publication > reports unlink cleanup failure alongside a primary link failure","v1.38 immutable receipt publication > reports cleanup durability uncertainty alongside a short write","v1.38 immutable receipt publication > reports cleanup durability uncertainty alongside target contention","v1.38 immutable receipt publication > reports descriptor cleanup failure alongside a primary write failure","v1.38 matrix scheduler > matrix scheduler preallocates stable four-attempt shards without changing requests","v1.38 matrix accounting > matrix accounting is invariant to valid terminal completion order","v1.38 matrix accounting > matrix accounting rejects missing terminal identities","v1.38 matrix accounting > matrix accounting rejects duplicate terminal identities","v1.38 matrix accounting > matrix accounting rejects conflicting terminal identities","v1.38 matrix accounting > matrix accounting rejects unknown terminal identities","v1.38 matrix accounting > matrix accounting rejects calibration alias terminal identities","v1.38 matrix accounting > matrix accounting rejects prior partial alias terminal identities","v1.38 matrix accounting > matrix accounting rejects retry alias terminal identities","v1.38 plan 262-18 attempt identity and CLI dispatch > derives stable public identities with full scheduler identities and inventory-owned shards","v1.38 plan 262-18 attempt identity and CLI dispatch > joins each full scheduler identity exactly once and copies inventory shard ownership","v1.38 plan 262-18 attempt identity and CLI dispatch > builds admitted and stopped v6 receipts from exact injected terminal mappings","v1.38 plan 262-18 attempt identity and CLI dispatch > CLI dispatch gives --write-plan-262-19-terminal-v2 exactly one handler owner","v1.38 plan 262-18 attempt identity and CLI dispatch > CLI dispatch gives --check-plan-262-19-terminal-v2 exactly one handler owner","v1.38 plan 262-18 authorization v2 and seal v2 > rejects standalone Plan 262-19 terminal schema mutations after root recomputation","v1.38 plan 262-18 authorization v2 and seal v2 > v2 publication rolls back injected write, fsync, link, readback, and cleanup faults","v1.38 plan 262-18 authorization v2 and seal v2 > builds the injected Plan 262-19 passed route with exact A2/B2 joins and terminal expiry","v1.38 shared Darwin scheduler observation > cancels all four shards after an injected Darwin failure following valid ticks","v1.38 shared Darwin scheduler observation > observes once for one tick and fans the immutable observation to all four active shards","v1.38 shared Darwin scheduler observation > runs direct A inventory through injected v5 calibration and v6 execution without live observation","v1.38 route ordinal 3 additive contracts > terminalizes a valid marker-without-receipt as consumed interruption","v1.38 route ordinal 3 additive contracts > terminalizes a valid calibration marker without invoking calibration","v1.38 route ordinal 3 additive contracts > terminalizes a valid reproduction marker without invoking reproduction","v1.38 route ordinal 3 additive contracts > requires pre-observation terminals to carry no later evidence","v1.38 route ordinal 3 additive contracts > dispatches additive command --write-plan-262-22-terminal-v1 to exactly one receipt owner","v1.38 route ordinal 3 additive contracts > dispatches additive command --check-plan-262-22-terminal-v1 to exactly one receipt owner","v1.38 matrix real process boundary > serializes pending RSS ticks and drains the owned request before one successful terminal","v1.38 matrix real process boundary > does not forgive a late permission denial after a prior valid RSS sample","v1.38 matrix real process boundary > keeps the external RSS observer timeout fixed at 200 ms","v1.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"\"","v1.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"0\"","v1.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"-1\"","v1.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"12 13\"","v1.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"12.5\"","v1.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"unknown\"","v1.38 matrix real process boundary > matrix real cleanup proof terminates a spawned shard after sampler denial","v1.38 matrix inline execution context v4 > matrix inline execution context v4 binds lean main ownership and terminal plan agents","v1.38 matrix cleanup > matrix cleanup cancels active shards, awaits exits, and leaves later shards unlaunched","v1.38 matrix cleanup > matrix cleanup fails closed when any orphan or missing exit proof remains","v1.38 matrix cancellation > matrix cancellation handles parent_exception with the same fail-closed cleanup","v1.38 matrix cancellation > matrix cancellation handles parent_interrupt with the same fail-closed cleanup","v1.38 matrix reduction > source A5 freezes route ordinal 5 writers without live or public expansion"] as const;
const PLAN_262_32_FOCUSED_TEST_NAME_PATTERN = "^(?:v1\\.38 pre-live post-live child protocol compatibility > post-live accepts the exact terminal-selected stopped row|v1\\.38 plan 262-15 terminal artifact presence > plan 262-15 terminal enforces seal_refused artifact presence|v1\\.38 plan 262-15 terminal artifact presence > plan 262-15 terminal enforces seal_failed artifact presence|v1\\.38 plan 262-15 terminal artifact presence > plan 262-15 terminal enforces sealed artifact presence|v1\\.38 plan 262-16 terminal artifact presence > plan 262-16 terminal validates the preflight-refused charged branch|v1\\.38 immutable receipt publication > reports cleanup-fsync failure without removing the canonical link|v1\\.38 immutable receipt publication > reports unlink cleanup failure alongside a primary link failure|v1\\.38 immutable receipt publication > reports cleanup durability uncertainty alongside a short write|v1\\.38 immutable receipt publication > reports cleanup durability uncertainty alongside target contention|v1\\.38 immutable receipt publication > reports descriptor cleanup failure alongside a primary write failure|v1\\.38 matrix scheduler > matrix scheduler preallocates stable four-attempt shards without changing requests|v1\\.38 matrix accounting > matrix accounting is invariant to valid terminal completion order|v1\\.38 matrix accounting > matrix accounting rejects missing terminal identities|v1\\.38 matrix accounting > matrix accounting rejects duplicate terminal identities|v1\\.38 matrix accounting > matrix accounting rejects conflicting terminal identities|v1\\.38 matrix accounting > matrix accounting rejects unknown terminal identities|v1\\.38 matrix accounting > matrix accounting rejects calibration alias terminal identities|v1\\.38 matrix accounting > matrix accounting rejects prior partial alias terminal identities|v1\\.38 matrix accounting > matrix accounting rejects retry alias terminal identities|v1\\.38 plan 262-18 attempt identity and CLI dispatch > derives stable public identities with full scheduler identities and inventory-owned shards|v1\\.38 plan 262-18 attempt identity and CLI dispatch > joins each full scheduler identity exactly once and copies inventory shard ownership|v1\\.38 plan 262-18 attempt identity and CLI dispatch > builds admitted and stopped v6 receipts from exact injected terminal mappings|v1\\.38 plan 262-18 attempt identity and CLI dispatch > CLI dispatch gives --write-plan-262-19-terminal-v2 exactly one handler owner|v1\\.38 plan 262-18 attempt identity and CLI dispatch > CLI dispatch gives --check-plan-262-19-terminal-v2 exactly one handler owner|v1\\.38 plan 262-18 authorization v2 and seal v2 > rejects standalone Plan 262-19 terminal schema mutations after root recomputation|v1\\.38 plan 262-18 authorization v2 and seal v2 > v2 publication rolls back injected write, fsync, link, readback, and cleanup faults|v1\\.38 plan 262-18 authorization v2 and seal v2 > builds the injected Plan 262-19 passed route with exact A2/B2 joins and terminal expiry|v1\\.38 shared Darwin scheduler observation > cancels all four shards after an injected Darwin failure following valid ticks|v1\\.38 shared Darwin scheduler observation > observes once for one tick and fans the immutable observation to all four active shards|v1\\.38 shared Darwin scheduler observation > runs direct A inventory through injected v5 calibration and v6 execution without live observation|v1\\.38 route ordinal 3 additive contracts > terminalizes a valid marker-without-receipt as consumed interruption|v1\\.38 route ordinal 3 additive contracts > terminalizes a valid calibration marker without invoking calibration|v1\\.38 route ordinal 3 additive contracts > terminalizes a valid reproduction marker without invoking reproduction|v1\\.38 route ordinal 3 additive contracts > requires pre-observation terminals to carry no later evidence|v1\\.38 route ordinal 3 additive contracts > dispatches additive command --write-plan-262-22-terminal-v1 to exactly one receipt owner|v1\\.38 route ordinal 3 additive contracts > dispatches additive command --check-plan-262-22-terminal-v1 to exactly one receipt owner|v1\\.38 matrix real process boundary > serializes pending RSS ticks and drains the owned request before one successful terminal|v1\\.38 matrix real process boundary > does not forgive a late permission denial after a prior valid RSS sample|v1\\.38 matrix real process boundary > keeps the external RSS observer timeout fixed at 200 ms|v1\\.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"\"|v1\\.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"0\"|v1\\.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"-1\"|v1\\.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"12 13\"|v1\\.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"12\\.5\"|v1\\.38 matrix real process boundary > matrix sampler denial rejects ambiguous RSS output \"unknown\"|v1\\.38 matrix real process boundary > matrix real cleanup proof terminates a spawned shard after sampler denial|v1\\.38 matrix inline execution context v4 > matrix inline execution context v4 binds lean main ownership and terminal plan agents|v1\\.38 matrix cleanup > matrix cleanup cancels active shards, awaits exits, and leaves later shards unlaunched|v1\\.38 matrix cleanup > matrix cleanup fails closed when any orphan or missing exit proof remains|v1\\.38 matrix cancellation > matrix cancellation handles parent_exception with the same fail-closed cleanup|v1\\.38 matrix cancellation > matrix cancellation handles parent_interrupt with the same fail-closed cleanup|v1\\.38 matrix reduction > source A5 freezes route ordinal 5 writers without live or public expansion)$";

type Plan26232ImmutableGitFixture = Readonly<{
  repoRoot: string
  sourceBase5: string
  sourceA5: string
  sourceA5Tree: string
  sourceA5Parent: string
  changedPaths: readonly string[]
  protectedBlobs: Readonly<Record<string, string>>
}>
    ...
    try {
      ...
      await expect(
        writeV138ParallelCalibrationV5Receipt(
          ...
          async () => {
            expiredProviderCalls += 1
            throw new Error("expired calibration callback")
          },
        ),
      ).rejects.toThrow("MATRIX_PLAN_262_16_AUTHORITY_EXPIRED")
      await expect(
        writeV138AuthoritativeMatrixV6Receipt(
          ...
          async () => {
            expiredProviderCalls += 1
            throw new Error("expired reproduction callback")
          },
        ),
      ).rejects.toThrow("MATRIX_PLAN_262_16_AUTHORITY_EXPIRED")
      expect(expiredProviderCalls).toBe(0)
...
describe("v1.38 plan 262-18 attempt identity and CLI dispatch", () => {
  ...
  it("builds admitted and stopped v6 receipts from exact injected terminal mappings", async () => {
    ...
    expect(admitted.supervisionRoot).toMatch(/^sha256:[0-9a-f]{64}$/u)
    expect(admitted.supervisionRoot).not.toBe(calibration.calibrationRoot)
    ...
    for (const mutate of [
      (candidate: typeof admitted) => {
        candidate.chargedAttempts[0]!.outcome = "bottom_win"
      },
      (candidate: typeof admitted) => {
        candidate.shardProof[0]!.laneId = "lane:foreign"
      },
      (candidate: typeof admitted) => {
        candidate.sharedTickProof[0]!.shardIds[0] =
          "calibration-shard:foreign"
      },
      (candidate: typeof admitted) => {
        candidate.supervisionRoot = `sha256:${"f".repeat(64)}`
      },
    ]) {
      const forged = clone(admitted)
      mutate(forged)
      const { receiptRoot: _forgedRoot, ...forgedBody } = forged
      forged.receiptRoot = v138SuccessorRoot(
        "budgetProfile",
      ...
      expect(() =>
        checkV138ParallelCalibrationV6Receipt(inventory, forged),
  ...
  it("derives v6 launch counts only from typed launch events and rejects shared-tick drift", async () => {
    ...
    const unavailable = await calibrateV138ParallelMatrix({
      inventory,
      runner: successfulInjectedRunner(),
      hardwareIdentity,
      sharedHeadroomObserver: async () => {
        throw new Error("injected observation unavailable")
      },
      executionIdentityVersion: "v6",
    })
    ...
    const unavailableReceipt = buildV138ParallelCalibrationV6Receipt({
      inventory,
      ...identity,
      preflightDisposition: "preflight_admitted",
    ...
    expect(unavailableReceipt).toMatchObject({
      status: "stopped_process_failure",
      publicStopReason: "RESOURCE_MEASUREMENT_UNAVAILABLE",
      sharedTickProof: [],
      acceptedCellCount: 0,
      noRetry: true,
    })
    expect(
      checkV138ParallelCalibrationV6Receipt(
        inventory,
        clone(unavailableReceipt),
      ),
    ).toEqual(unavailableReceipt)
...
describe("v1.38 plan 262-18 authorization v2 and seal v2", () => {
  ...
  it("durably rolls back every Plan 262-19 stage after directory-fsync uncertainty", () => {
    const root = mkdtempSync(path.join(tmpdir(), "cowards-262-19-durability-"))
    try {
      mkdirSync(path.resolve(root, ".planning/artifacts"), { recursive: true })
      for (const [ordinal, repoPath] of
        V138_PLAN_262_19_FRESH_DESTINATIONS.entries()) {
  ...
  it("builds the injected Plan 262-19 passed route with exact A2/B2 joins and terminal expiry", async () => {
    ...
    try {
      ...
      const unavailableSupervision = await calibrateV138ParallelMatrix({
        inventory,
        runner: successfulInjectedRunner(),
        sharedHeadroomObserver: async () => {
          throw new Error("injected observation unavailable")
      ...
      const unavailableCalibration = buildV138ParallelCalibrationV6Receipt({
        inventory,
        sourceB2,
        sourceB2CustodyRoot: context.sourceB2CustodyRoot,
        executionContextRoot: context.receiptRoot,
        preflightRoot: preflight.receiptRoot,
        preflightDisposition: "preflight_admitted",
        calibration: unavailableSupervision,
      })
      const unavailableTerminal = buildV138Plan26219TerminalV2({
      ...
      for (const mutate of [
        ...
        const forged = clone(reproduction)
        mutate(forged)
        const { receiptRoot: _forgedRoot, ...forgedBody } = forged
        forged.receiptRoot = v138SuccessorRoot(
          "evidenceBundle",
        ...
        expect(() =>
          checkV138AuthoritativeMatrixV7Receipt(forged, {
            repoRoot: root,
            executionContext: context,
            preflight,
            calibration,
      ...
      writeFileSync(
        path.resolve(root, V138_PLAN_262_19_FRESH_DESTINATIONS[4]),
        canonicalManifest(terminal),
      )
      expect(() =>
        writeV138ExecutionContextV6Receipt(
          root,
          ...
          context.terminalAgentRegistry,
          authorizationPath,
          sealPath,
          sourceA2,
          sourceB2,
        ),
      ).toThrow("MATRIX_PLAN_262_19_AUTHORITY_EXPIRED")
      ...
      ).rejects.toThrow("MATRIX_PLAN_262_19_AUTHORITY_EXPIRED")
      await expect(
        writeV138ParallelCalibrationV6Receipt(
          root,
          V138_PLAN_262_19_FRESH_DESTINATIONS[2],
...
describe("v1.38 matrix inline execution context v4", () => {
  it("matrix inline execution context v4 binds lean main ownership and terminal plan agents", () => {
    resolvePlan26232ImmutableGitFixture({
      ...
      sourceA5Tree: PLAN_262_32_A5_TREE,
      sourceA5Parent: PLAN_262_32_A5_PARENT,
      changedPaths: V138_SUCCESSOR_AUTHORIZED_SOURCE_PATHS_V5,
      protectedBlobs: {
