...
describe("bounded lean runner", () => {
  ...
  it("exposes one direct launch selector and retires recovery from active dispatch", () => {
    ...
    expect(main).toContain("loadAndCheckLeanDirectReviewedReadyV6")
    expect(main).toContain("LEAN_DIRECT_V6_ARTIFACT_PATHS.invocation")
    expect(main).toContain("createLeanDirectTerminalArtifactV6")
