...
describe("bounded lean runner", () => {
  ...
  it("exposes one direct launch selector and retires recovery from active dispatch", () => {
    ...
    expect(main).toContain("loadAndCheckLeanDirectReviewedReadyV7")
    expect(main).toContain("LEAN_DIRECT_V7_ARTIFACT_PATHS.invocation")
    expect(main).toContain("createLeanDirectTerminalArtifactV7")
