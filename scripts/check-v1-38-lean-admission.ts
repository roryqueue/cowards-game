...
export const LEAN_DIRECT_V10_ARTIFACT_PATHS = Object.freeze({
...
export const LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH = ".planning/artifacts/v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v1.json" as const
export const LEAN_DIRECT_V11_ARTIFACT_PATHS = Object.freeze({
...
export const LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH = ".planning/artifacts/v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v2.json" as const
export const LEAN_DIRECT_V12_ARTIFACT_PATHS = Object.freeze({
...
export interface LeanWorkerLifecycleDiagnosticV1 {
  readonly schemaVersion: "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v1"
  readonly sourceCommit: string
  readonly sourceTree: string
  readonly executableClosureRoot: `sha256:${string}`
  readonly image: typeof LEAN_CONTAINER_IMAGE
  readonly controlsRoot: `sha256:${string}`
  readonly attemptOrdinal: 2
  readonly attemptLimit: 10
  readonly stage: "pass" | "docker_unavailable" | "image_invalid" | "broker_failed" | "cleanup_incomplete" | "unexpected_failure"
  readonly requestCounts: { readonly legacy: 1; readonly v117: 1; readonly successful: number }
...
export interface LeanContainerPreflightArtifactV9 extends Omit<LeanContainerPreflightArtifactV8, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-container-preflight-v9" }
export interface LeanDirectAuthorizationV10 extends Omit<LeanDirectAuthorizationV9, "schemaVersion" | "containerPreflight"> {
  readonly schemaVersion: "v1.38-lean-runner-direct-authorization-v10"
  readonly containerPreflight: { readonly path: typeof LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight; readonly root: `sha256:${string}` }
  readonly workerLifecycleDiagnostic: { readonly path: typeof LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH; readonly root: `sha256:${string}`; readonly status: "pass" }
  readonly plan192History: { readonly preflightPath: typeof LEAN_DIRECT_V9_ARTIFACT_PATHS.preflight; readonly preflightSha256: `sha256:${string}`; readonly reviewPath: typeof LEAN_DIRECT_V9_ARTIFACT_PATHS.review; readonly reviewSha256: `sha256:${string}`; readonly status: "non_pass_preserved" }
}
export interface LeanDirectValidityReviewV10 extends Omit<LeanDirectValidityReviewV9, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-validity-review-v10" }
export interface LeanDirectInvocationV10 extends Omit<LeanDirectInvocationV9, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-invocation-v10" }
export interface LeanDirectTerminalArtifactV10 extends Omit<LeanDirectInvocationV10, "schemaVersion" | "claimClass" | "invocationOrdinal"> { readonly schemaVersion: "v1.38-lean-runner-direct-terminal-v10"; readonly invocationRoot: `sha256:${string}`; readonly privacy: "safe_aggregate_only"; readonly terminal: LeanTerminal }
export interface LeanWorkerLifecycleDiagnosticV2 extends Omit<LeanWorkerLifecycleDiagnosticV1, "schemaVersion" | "attemptOrdinal"> {
  readonly schemaVersion: "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v2"
  readonly attemptOrdinal: 3
}
export interface LeanContainerPreflightArtifactV10 extends Omit<LeanContainerPreflightArtifactV9, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-container-preflight-v10" }
export interface LeanDirectAuthorizationV11 extends Omit<LeanDirectAuthorizationV9, "schemaVersion" | "containerPreflight"> {
  readonly schemaVersion: "v1.38-lean-runner-direct-authorization-v11"
  readonly containerPreflight: { readonly path: typeof LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight; readonly root: `sha256:${string}` }
  readonly workerLifecycleDiagnostic: { readonly path: typeof LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH; readonly root: `sha256:${string}`; readonly status: "pass" }
  readonly diagnosticV1History: { readonly path: typeof LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH; readonly root: `sha256:${string}`; readonly status: "docker_unavailable_preserved" }
  readonly plan192History: { readonly preflightPath: typeof LEAN_DIRECT_V9_ARTIFACT_PATHS.preflight; readonly preflightSha256: `sha256:${string}`; readonly reviewPath: typeof LEAN_DIRECT_V9_ARTIFACT_PATHS.review; readonly reviewSha256: `sha256:${string}`; readonly status: "non_pass_preserved" }
}
export interface LeanDirectValidityReviewV11 extends Omit<LeanDirectValidityReviewV10, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-validity-review-v11" }
export interface LeanDirectInvocationV11 extends Omit<LeanDirectInvocationV10, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-invocation-v11" }
export interface LeanDirectTerminalArtifactV11 extends Omit<LeanDirectInvocationV11, "schemaVersion" | "claimClass" | "invocationOrdinal"> { readonly schemaVersion: "v1.38-lean-runner-direct-terminal-v11"; readonly invocationRoot: `sha256:${string}`; readonly privacy: "safe_aggregate_only"; readonly terminal: LeanTerminal }
export interface LeanWorkerLifecycleDiagnosticV3 extends Omit<LeanWorkerLifecycleDiagnosticV2, "schemaVersion" | "attemptOrdinal"> {
  readonly schemaVersion: "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v3"
  readonly attemptOrdinal: 5
}
export interface LeanContainerPreflightArtifactV11 extends Omit<LeanContainerPreflightArtifactV10, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-container-preflight-v11" }
export interface LeanDirectAuthorizationV12 extends Omit<LeanDirectAuthorizationV11, "schemaVersion" | "containerPreflight" | "workerLifecycleDiagnostic"> {
  readonly schemaVersion: "v1.38-lean-runner-direct-authorization-v12"
  readonly containerPreflight: { readonly path: typeof LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight; readonly root: `sha256:${string}` }
  readonly workerLifecycleDiagnostic: { readonly path: typeof LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH; readonly root: `sha256:${string}`; readonly status: "pass" }
  readonly diagnosticV2History: { readonly path: typeof LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH; readonly root: `sha256:${string}`; readonly status: "docker_unavailable_preserved" }
  readonly attempt4History: { readonly path: ".planning/debug/phase-262-probe-failed.md"; readonly contentSha256: `sha256:${string}`; readonly status: "read_only_zero_effect_preserved" }
  readonly correctiveInvocationLimit: 1
  readonly correctiveInvocationsConsumed: 0
}
export interface LeanDirectValidityReviewV12 extends Omit<LeanDirectValidityReviewV11, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-validity-review-v12" }
export interface LeanDirectInvocationV12 extends Omit<LeanDirectInvocationV11, "schemaVersion"> { readonly schemaVersion: "v1.38-lean-runner-direct-invocation-v12" }
export interface LeanDirectTerminalArtifactV12 extends Omit<LeanDirectInvocationV12, "schemaVersion" | "claimClass" | "invocationOrdinal"> { readonly schemaVersion: "v1.38-lean-runner-direct-terminal-v12"; readonly invocationRoot: `sha256:${string}`; readonly privacy: "safe_aggregate_only"; readonly terminal: LeanTerminal }
...
const LEAN_DIRECT_PLAN192_PREFLIGHT_SHA256 = "ad48272e48958e9970778f7ede34c67ac935ce6063b3da52fab68cb23859f0b7" as const
const LEAN_DIRECT_PLAN192_REVIEW_SHA256 = "3c381f29baaaaf5f1bf3ff3b4169ddb7a19274bc41ab67171d2217b54a43cf47" as const
const assertLeanDirectPlan192History = (repoRoot: string): void => {
  if (sha256File(path.resolve(repoRoot, LEAN_DIRECT_V9_ARTIFACT_PATHS.preflight)) !== LEAN_DIRECT_PLAN192_PREFLIGHT_SHA256 || sha256File(path.resolve(repoRoot, LEAN_DIRECT_V9_ARTIFACT_PATHS.review)) !== LEAN_DIRECT_PLAN192_REVIEW_SHA256) throw new TypeError("LEAN_DIRECT_PLAN192_HISTORY_DRIFT")
  const preflight = readJson(repoRoot, LEAN_DIRECT_V9_ARTIFACT_PATHS.preflight); const review = readJson(repoRoot, LEAN_DIRECT_V9_ARTIFACT_PATHS.review)
  if (!isObject(preflight) || !isObject(preflight.preflight) || preflight.preflight.status !== "non_pass" || preflight.matchInvocations !== 0 || !exactFalseAuthority(preflight.authority) || !isObject(review) || review.admitsPlan175 !== false || review.blockingFindingCount !== 0 || !exactFalseAuthority(review.authority)) throw new TypeError("LEAN_DIRECT_PLAN192_HISTORY_REINTERPRETED")
  for (const artifactPath of [LEAN_DIRECT_V9_ARTIFACT_PATHS.authorization, LEAN_DIRECT_V9_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V9_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V9_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V9_ARTIFACT_PATHS.eligibility]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_PLAN192_HISTORY_EFFECT:${artifactPath}`)
}
const assertLeanDirectV10PathsAreFresh = (): void => {
  const historical = [...Object.values(LEAN_DIRECT_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V2_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V3_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V4_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V5_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V6_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V7_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V8_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V9_ARTIFACT_PATHS)]
  const fresh = [...Object.values(LEAN_DIRECT_V10_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH]
  if (new Set(fresh).size !== fresh.length || fresh.some((candidate) => historical.includes(candidate as never))) throw new TypeError("LEAN_DIRECT_V10_PATH_ALIAS")
}
const resolveLeanDirectV10Source = (repoRoot: string, explicitRef: string, rejectCurrentHead: boolean): LeanManifest["source"] => resolveLeanDirectV9Source(repoRoot, explicitRef, rejectCurrentHead)
const assertLeanDirectWorkerLifecycleSource = (repoRoot: string, sourceCommit: string): void => {
  const source = git(repoRoot, ["show", `${sourceCommit}:scripts/lib/v1-38-lean-container-match-session.ts`]); const tests = git(repoRoot, ["show", `${sourceCommit}:scripts/lib/v1-38-lean-container-match-session.test.ts`]); const broker = source.match(/export const LEAN_CONTAINER_BROKER_SOURCE = `[\s\S]*?\n`\n\nconst STREAM_WORKER_SOURCE/u)?.[0] ?? ""
  const required = ['from "node:worker_threads"', "new Worker(", "env: {}", "execArgv: []", "resourceLimits:", 'kind:"completion"', 'port.on("close"', 'worker.on("exit"', "await reconcile()", "queue=queue.then", "requestId:q.requestId"]
  if (required.some((token) => !broker.includes(token)) || broker.includes("receiveMessageOnPort") || broker.includes("node:child_process") || broker.includes("spawnSync") || broker.includes("transport(dockerPath") || broker.includes("fallback")) throw new TypeError("LEAN_DIRECT_V10_WORKER_LIFECYCLE_SOURCE_DRIFT")
  for (const token of ["waits beyond the obsolete 100 ms success race", "requires the same completion and natural-exit handshake for v1.17", "fails closed without a response", "rejects a completion receipt whose request identity does not match"]) if (!tests.includes(token)) throw new TypeError("LEAN_DIRECT_V10_WORKER_LIFECYCLE_TEST_DRIFT")
}
const assertLeanDirectV10TrackedBytes = (repoRoot: string, sourceCommit: string): void => {
  try { execFileSync("git", ["diff", "--quiet", sourceCommit, "--", ...LEAN_DIRECT_V4_EXECUTABLE_CLOSURE_PATHS], { cwd: repoRoot, stdio: "ignore" }) } catch { throw new TypeError("LEAN_DIRECT_V10_TRACKED_BYTES_DRIFT") }
  assertLeanPersistentStreamSource(repoRoot, sourceCommit); assertLeanDirectV8ExactAbsenceSource(repoRoot, sourceCommit); assertLeanDirectWorkerLifecycleSource(repoRoot, sourceCommit)
}
...
const diagnosticRequest = (requestId: number, mode: "legacy" | "v117"): Record<string, unknown> => {
  const source = "module.exports.default={selectActivations(){return []}}"; const payload = mode === "legacy" ? { source, methodName: "selectActivations", input: {}, outputByteLimit: 1024 } : { source, methodName: "selectActivations", input: {}, outputByteLimit: 1024, methodWallMilliseconds: 5_000, startupTimeoutMilliseconds: 5_000, cancellationGraceMilliseconds: 100 }
  return { requestId, mode, payloadBase64: Buffer.from(JSON.stringify(payload)).toString("base64"), timeoutMilliseconds: mode === "legacy" ? 5_000 : 10_100, stdoutByteLimit: 4096, stderrByteLimit: 4096 }
}
const buildLeanWorkerLifecycleDiagnosticV1 = (repoRoot: string, explicitSourceRef: string, observed: Omit<LeanWorkerLifecycleDiagnosticV1, "schemaVersion" | "sourceCommit" | "sourceTree" | "executableClosureRoot" | "image" | "controlsRoot" | "attemptOrdinal" | "attemptLimit" | "preflightInvocations" | "matchInvocations" | "authority">): LeanWorkerLifecycleDiagnosticV1 => {
  const source = resolveLeanDirectV10Source(repoRoot, explicitSourceRef, false)
  return { schemaVersion: "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v1", sourceCommit: source.commit, sourceTree: source.tree, executableClosureRoot: hashLeanValue(source.executableBlobs), image: LEAN_CONTAINER_IMAGE, controlsRoot: hashLeanValue(LEAN_CONTAINER_CONTROLS), attemptOrdinal: 2, attemptLimit: 10, ...observed, preflightInvocations: 0, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE }
}
export const validateLeanWorkerLifecycleDiagnosticV1 = (repoRoot: string, value: unknown): LeanWorkerLifecycleDiagnosticV1 => {
  assertPrivacySafe(value)
  if (!isObject(value) || !exactKeys(value, ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "image", "controlsRoot", "attemptOrdinal", "attemptLimit", "stage", "requestCounts", "elapsedMilliseconds", "streamClosed", "cleanupComplete", "preflightInvocations", "matchInvocations", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v1" || !isOid(value.sourceCommit) || !isOid(value.sourceTree) || !isSha(value.executableClosureRoot) || value.image !== LEAN_CONTAINER_IMAGE || value.controlsRoot !== hashLeanValue(LEAN_CONTAINER_CONTROLS) || value.attemptOrdinal !== 2 || value.attemptLimit !== 10 || !["pass", "docker_unavailable", "image_invalid", "broker_failed", "cleanup_incomplete", "unexpected_failure"].includes(String(value.stage)) || !isObject(value.requestCounts) || !exactKeys(value.requestCounts, ["legacy", "v117", "successful"]) || value.requestCounts.legacy !== 1 || value.requestCounts.v117 !== 1 || !Number.isSafeInteger(value.requestCounts.successful) || (value.requestCounts.successful as number) < 0 || (value.requestCounts.successful as number) > 2 || typeof value.elapsedMilliseconds !== "number" || !Number.isFinite(value.elapsedMilliseconds) || value.elapsedMilliseconds < 0 || typeof value.streamClosed !== "boolean" || typeof value.cleanupComplete !== "boolean" || value.preflightInvocations !== 0 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_INVALID")
  const source = resolveLeanDirectV10Source(repoRoot, value.sourceCommit, false); if (value.sourceTree !== source.tree || value.executableClosureRoot !== hashLeanValue(source.executableBlobs)) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_SOURCE_DRIFT")
  if (value.stage === "pass" ? value.requestCounts.successful !== 2 || value.streamClosed !== true || value.cleanupComplete !== true : value.requestCounts.successful === 2 && value.streamClosed === true && value.cleanupComplete === true) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_DISPOSITION_INVALID")
  return globalThis.structuredClone(value) as unknown as LeanWorkerLifecycleDiagnosticV1
}
export const writeLeanDirectWorkerLifecycleDiagnosticV1 = (repoRoot: string, explicitSourceRef: string): LeanWorkerLifecycleDiagnosticV1 => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectPlan192History(repoRoot); assertLeanDirectV10PathsAreFresh(); for (const artifactPath of [...Object.values(LEAN_DIRECT_V10_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V10_DESTINATION_EXISTS:${artifactPath}`)
  const sourceRef = validateLeanDirectV2ExplicitSourceRef(explicitSourceRef); const source = resolveLeanDirectV10Source(repoRoot, sourceRef, false); assertLeanDirectV10TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot)
  const name = `cg-v138-lifecycle-${source.commit.slice(0, 16)}`; const started = process.hrtime.bigint(); let stage: LeanWorkerLifecycleDiagnosticV1["stage"] = "unexpected_failure"; let successful = 0; let streamClosed = false; let cleanupComplete = false; let created = false
  try {
    const image = diagnosticDocker(["image", "inspect", "--format", "{{json .RepoDigests}}", LEAN_CONTAINER_IMAGE]); if (image.error !== undefined || image.status !== 0 || image.signal !== null || !String(image.stdout).includes(LEAN_CONTAINER_IMAGE.slice(LEAN_CONTAINER_IMAGE.indexOf("@")))) throw new TypeError("image_invalid")
    const absent = diagnosticDocker(["inspect", name]); if (!exactDockerAbsentDiagnostic(absent.status, absent.signal, absent.error, String(absent.stdout), String(absent.stderr), name)) throw new TypeError("docker_unavailable")
    const createdResult = diagnosticDocker(["create", "--name", name, "--label", `v1.38-lean-owner=diagnostic:${source.commit}`, "--interactive", "--network", "none", "--read-only", "--tmpfs", "/tmp:rw,noexec,nosuid,size=16m", "--memory", "64m", "--cpus", "0.5", "--pids-limit", "64", "--cap-drop", "ALL", "--security-opt", "no-new-privileges", "--env", "NODE_ENV=production", "--workdir", "/tmp", LEAN_CONTAINER_IMAGE, "node", "--input-type=module", "--eval", "process.stdin.resume();setInterval(()=>{},2147483647)"]); if (createdResult.error !== undefined || createdResult.status !== 0 || createdResult.signal !== null || String(createdResult.stderr) !== "") throw new TypeError("docker_unavailable"); created = true
    const startedResult = diagnosticDocker(["start", name]); if (startedResult.error !== undefined || startedResult.status !== 0 || startedResult.signal !== null || String(startedResult.stderr) !== "") throw new TypeError("docker_unavailable")
    const input = [diagnosticRequest(1, "legacy"), diagnosticRequest(2, "v117")].map((request) => JSON.stringify(request)).join("\n") + "\n"; const broker = diagnosticDocker(["exec", "-i", name, "node", "--input-type=module", "--eval", LEAN_CONTAINER_BROKER_SOURCE], input); streamClosed = broker.error === undefined && broker.status === 0 && broker.signal === null && String(broker.stderr) === ""
    if (!streamClosed) throw new TypeError("broker_failed"); const lines = String(broker.stdout).trim().split("\n"); if (lines.length !== 2) throw new TypeError("broker_failed"); const frames = lines.map((line) => JSON.parse(line) as Record<string, unknown>); if (frames.some((frame, index) => frame.requestId !== index + 1 || frame.status !== 0 || frame.signal !== null || frame.stderrBase64 !== "" || typeof frame.stdoutBase64 !== "string")) throw new TypeError("broker_failed")
    const legacy = JSON.parse(Buffer.from(frames[0]!.stdoutBase64 as string, "base64").toString("utf8")) as unknown; const v117 = Buffer.from(frames[1]!.stdoutBase64 as string, "base64"); if (!isObject(legacy) || legacy.ok !== true || !Array.isArray(legacy.value) || v117.subarray(0, 4).toString("ascii") !== "CG17" || v117.subarray(24, 25).toString("ascii") !== "S") throw new TypeError("broker_failed"); successful = 2; stage = "pass"
  } catch (error) { const code = error instanceof Error ? error.message : "unexpected_failure"; stage = ["docker_unavailable", "image_invalid", "broker_failed"].includes(code) ? code as LeanWorkerLifecycleDiagnosticV1["stage"] : "unexpected_failure" }
  finally { if (created) { const removed = diagnosticDocker(["rm", "--force", name]); const absent = diagnosticDocker(["inspect", name]); cleanupComplete = removed.error === undefined && removed.status === 0 && removed.signal === null && exactDockerAbsentDiagnostic(absent.status, absent.signal, absent.error, String(absent.stdout), String(absent.stderr), name) } else cleanupComplete = true; if (!cleanupComplete) stage = "cleanup_incomplete" }
  const diagnostic = buildLeanWorkerLifecycleDiagnosticV1(repoRoot, sourceRef, { stage, requestCounts: { legacy: 1, v117: 1, successful }, elapsedMilliseconds: Number(process.hrtime.bigint() - started) / 1_000_000, streamClosed, cleanupComplete }); validateLeanWorkerLifecycleDiagnosticV1(repoRoot, diagnostic); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH), diagnostic); return diagnostic
}
export const checkLeanDirectWorkerLifecycleDiagnosticV1 = (repoRoot: string): LeanWorkerLifecycleDiagnosticV1 => { assertLeanDirectPlan192History(repoRoot); const diagnostic = validateLeanWorkerLifecycleDiagnosticV1(repoRoot, readJson(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH)); assertLeanDirectV10TrackedBytes(repoRoot, diagnostic.sourceCommit); assertSuccessorLockInventory(repoRoot); return diagnostic }
export const checkLeanDirectWorkerLifecycleSourceOnlyV10 = (repoRoot: string): void => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); checkLeanFirstEvidenceCustody(repoRoot); assertDeniedDirectV1History(repoRoot); assertLeanDirectPlan178History(repoRoot); assertLeanDirectPlan180History(repoRoot); assertLeanDirectPlan182History(repoRoot); assertLeanDirectPlan184History(repoRoot); assertLeanDirectPlan186History(repoRoot); assertLeanDirectPlan190History(repoRoot); assertLeanDirectPlan192History(repoRoot); assertLeanDirectV10PathsAreFresh()
  for (const artifactPath of [...Object.values(LEAN_DIRECT_V10_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V10_DESTINATION_EXISTS:${artifactPath}`)
  const latest = git(repoRoot, ["log", "-1", "--format=%H", "--", ...LEAN_PLAN177_RUNNABLE_PATHS]); const source = resolveLeanDirectV10Source(repoRoot, latest, false); if (source.commit !== latest || Object.keys(source.executableBlobs).length !== 29) throw new TypeError("LEAN_DIRECT_V10_SOURCE_DRIFT"); assertLeanDirectV10TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot)
}
const buildLeanContainerPreflightArtifactV9 = (repoRoot: string, explicitSourceRef: string, outcome: unknown): LeanContainerPreflightArtifactV9 => {
  const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV1(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V10_DIAGNOSTIC_NOT_PASS"); const source = resolveLeanDirectV10Source(repoRoot, explicitSourceRef, true); if (diagnostic.sourceCommit !== source.commit || diagnostic.sourceTree !== source.tree || diagnostic.executableClosureRoot !== hashLeanValue(source.executableBlobs)) throw new TypeError("LEAN_DIRECT_V10_DIAGNOSTIC_SOURCE_DRIFT")
  return { schemaVersion: "v1.38-lean-runner-direct-container-preflight-v9", sourceCommit: source.commit, sourceTree: source.tree, executableClosureRoot: hashLeanValue(source.executableBlobs), preflight: validateLeanContainerPreflightOutcomeV4(outcome), consuming: false, preflightInvocations: 1, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE }
}
export const renderLeanContainerPreflightArtifactV9 = (repoRoot: string, explicitSourceRef: string, outcome: unknown): LeanContainerPreflightArtifactV9 => { assertLeanDirectPlan192History(repoRoot); assertLeanDirectV10PathsAreFresh(); return buildLeanContainerPreflightArtifactV9(repoRoot, explicitSourceRef, outcome) }
export const validateLeanContainerPreflightArtifactV9 = (repoRoot: string, value: unknown): LeanContainerPreflightArtifactV9 => { assertPrivacySafe(value); if (!isObject(value) || !exactKeys(value, ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "preflight", "consuming", "preflightInvocations", "matchInvocations", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-container-preflight-v9" || !isOid(value.sourceCommit) || !isOid(value.sourceTree) || !isSha(value.executableClosureRoot) || value.consuming !== false || value.preflightInvocations !== 1 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V10_PREFLIGHT_INVALID"); const expected = buildLeanContainerPreflightArtifactV9(repoRoot, value.sourceCommit, value.preflight); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V10_PREFLIGHT_DRIFT"); return globalThis.structuredClone(value) as unknown as LeanContainerPreflightArtifactV9 }
export const writeLeanContainerPreflightArtifactV9 = (repoRoot: string, explicitSourceRef: string): LeanContainerPreflightArtifactV9 => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectPlan192History(repoRoot); assertLeanDirectV10PathsAreFresh(); const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV1(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V10_DIAGNOSTIC_NOT_PASS"); for (const artifactPath of Object.values(LEAN_DIRECT_V10_ARTIFACT_PATHS)) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V10_DESTINATION_EXISTS:${artifactPath}`)
  const sourceRef = validateLeanDirectV2ExplicitSourceRef(explicitSourceRef); const source = resolveLeanDirectV10Source(repoRoot, sourceRef, true); assertLeanDirectV10TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot); let outcome: LeanContainerPreflightOutcomeV4; try { outcome = runActualLeanContainerPreflight() } catch (error) { outcome = { status: "non_pass", reasonCode: classifyLeanContainerPreflightFailure(error) } }; const artifact = renderLeanContainerPreflightArtifactV9(repoRoot, sourceRef, outcome); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight), artifact); return artifact
}
const buildLeanDirectAuthorizationV10 = (repoRoot: string, explicitSourceRef: string, preflight: LeanContainerPreflightArtifactV9): LeanDirectAuthorizationV10 => {
  if (preflight.preflight.status !== "pass") throw new TypeError("LEAN_DIRECT_V10_PREFLIGHT_NOT_PASS"); const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV1(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V10_DIAGNOSTIC_NOT_PASS"); const source = resolveLeanDirectV10Source(repoRoot, explicitSourceRef, true); if (preflight.sourceCommit !== source.commit || preflight.sourceTree !== source.tree || preflight.executableClosureRoot !== hashLeanValue(source.executableBlobs) || diagnostic.sourceCommit !== source.commit) throw new TypeError("LEAN_DIRECT_V10_SOURCE_DRIFT")
  const base = buildLeanDirectAuthorizationV9(repoRoot, source.commit, { ...preflight, schemaVersion: "v1.38-lean-runner-direct-container-preflight-v8" } as LeanContainerPreflightArtifactV8)
  return { ...base, schemaVersion: "v1.38-lean-runner-direct-authorization-v10", source, containerPreflight: { path: LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight, root: hashLeanValue(preflight) }, workerLifecycleDiagnostic: { path: LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH, root: hashLeanValue(diagnostic), status: "pass" }, plan192History: { preflightPath: LEAN_DIRECT_V9_ARTIFACT_PATHS.preflight, preflightSha256: `sha256:${LEAN_DIRECT_PLAN192_PREFLIGHT_SHA256}`, reviewPath: LEAN_DIRECT_V9_ARTIFACT_PATHS.review, reviewSha256: `sha256:${LEAN_DIRECT_PLAN192_REVIEW_SHA256}`, status: "non_pass_preserved" } }
}
export const renderLeanDirectAuthorizationV10 = (repoRoot: string, explicitSourceRef: string): LeanDirectAuthorizationV10 => { assertLeanDirectPlan192History(repoRoot); const preflight = validateLeanContainerPreflightArtifactV9(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight)); for (const artifactPath of Object.values(LEAN_DIRECT_V10_ARTIFACT_PATHS).filter((candidate) => candidate !== LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight)) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V10_DESTINATION_EXISTS:${artifactPath}`); return buildLeanDirectAuthorizationV10(repoRoot, validateLeanDirectV2ExplicitSourceRef(explicitSourceRef), preflight) }
export const validateLeanDirectAuthorizationV10 = (repoRoot: string, value: unknown): LeanDirectAuthorizationV10 => { assertPrivacySafe(value); if (!isObject(value) || value.schemaVersion !== "v1.38-lean-runner-direct-authorization-v10" || !isObject(value.source) || !isOid(value.source.commit) || value.recoveryAuthorized !== false || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V10_AUTHORIZATION_INVALID"); const expected = buildLeanDirectAuthorizationV10(repoRoot, value.source.commit, validateLeanContainerPreflightArtifactV9(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight))); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V10_AUTHORIZATION_DRIFT"); return globalThis.structuredClone(value) as unknown as LeanDirectAuthorizationV10 }
export const checkLeanDirectAuthorizationV10 = (repoRoot: string, value: unknown): LeanDirectAuthorizationV10 => { const authorization = validateLeanDirectAuthorizationV10(repoRoot, value); assertLeanDirectV10TrackedBytes(repoRoot, authorization.source.commit); assertLeanDirectPlan192History(repoRoot); assertSuccessorLockInventory(repoRoot); return authorization }
export const writeLeanDirectAuthorizationV10 = (repoRoot: string, explicitSourceRef: string): LeanDirectAuthorizationV10 => { const authorization = renderLeanDirectAuthorizationV10(repoRoot, explicitSourceRef); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.authorization), authorization); return authorization }
export const checkLeanDirectValidityReviewV10 = (repoRoot: string, value: unknown): LeanDirectValidityReviewV10 => {
  assertPrivacySafe(value); const preflight = validateLeanContainerPreflightArtifactV9(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight)); const authorizationPresent = existsSync(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.authorization)); const authorization = authorizationPresent ? checkLeanDirectAuthorizationV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.authorization)) : undefined
  if (!isObject(value) || !exactKeys(value, ["schemaVersion", "authorizationRoot", "preflightRoot", "sourceCommit", "sourceTree", "categories", "blockingFindingCount", "certificationOnlyHistory", "admitsPlan175", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-validity-review-v10" || value.authorizationRoot !== (authorization === undefined ? null : hashLeanValue(authorization)) || value.preflightRoot !== hashLeanValue(preflight) || value.sourceCommit !== preflight.sourceCommit || value.sourceTree !== preflight.sourceTree || !Array.isArray(value.categories) || value.categories.length !== LEAN_DIRECT_VALIDITY_CATEGORIES.length || !Number.isSafeInteger(value.blockingFindingCount) || (value.blockingFindingCount as number) < 0 || JSON.stringify(value.certificationOnlyHistory) !== JSON.stringify(plan172Findings(repoRoot)) || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V10_REVIEW_INVALID")
  for (const [index, category] of LEAN_DIRECT_VALIDITY_CATEGORIES.entries()) { const item = value.categories[index]; if (!isObject(item) || !exactKeys(item, ["category", "status", "evidence"]) || item.category !== category || !["pass", "finding"].includes(String(item.status)) || typeof item.evidence !== "string" || item.evidence.length === 0) throw new TypeError("LEAN_DIRECT_V10_REVIEW_INVALID") }; const findings = value.categories.filter((item) => isObject(item) && item.status === "finding").length; const admitted = preflight.preflight.status === "pass" && authorization !== undefined && findings === 0; if (value.blockingFindingCount !== findings || value.admitsPlan175 !== admitted) throw new TypeError("LEAN_DIRECT_V10_REVIEW_INVALID"); return globalThis.structuredClone(value) as unknown as LeanDirectValidityReviewV10
}
export const loadAndCheckLeanDirectReviewedReadyV10 = (repoRoot: string, allowedOperationalPaths: readonly string[] = []): { authorization: LeanDirectAuthorizationV10; review: LeanDirectValidityReviewV10; preflight: LeanContainerPreflightArtifactV9 } => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"]), allowedOperationalPaths); for (const artifactPath of [LEAN_DIRECT_V10_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V10_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V10_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V10_ARTIFACT_PATHS.eligibility]) if (!allowedOperationalPaths.includes(artifactPath) && existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V10_EFFECT_EXISTS:${artifactPath}`); const preflight = validateLeanContainerPreflightArtifactV9(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight)); if (preflight.preflight.status !== "pass") throw new TypeError("LEAN_DIRECT_V10_PREFLIGHT_NOT_PASS"); const authorization = checkLeanDirectAuthorizationV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.authorization)); const review = checkLeanDirectValidityReviewV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.review)); if (!review.admitsPlan175 || review.blockingFindingCount !== 0) throw new TypeError("LEAN_DIRECT_V10_PLAN175_NOT_ADMITTED"); return { authorization, review, preflight } }
export const checkLeanDirectReviewDispositionV10 = (repoRoot: string): LeanDirectValidityReviewV10 => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"]), [LEAN_DIRECT_V10_ARTIFACT_PATHS.review]); const review = checkLeanDirectValidityReviewV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.review)); if (review.admitsPlan175) loadAndCheckLeanDirectReviewedReadyV10(repoRoot); else { for (const artifactPath of [LEAN_DIRECT_V10_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V10_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V10_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V10_ARTIFACT_PATHS.eligibility]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V10_DENIED_EFFECT:${artifactPath}`); if (Object.values(review.authority).some(Boolean)) throw new TypeError("LEAN_DIRECT_V10_DENIED_AUTHORITY") }; return review }
export const createLeanDirectInvocationV10 = (authorization: LeanDirectAuthorizationV10, review: LeanDirectValidityReviewV10, childCapabilityRoot: `sha256:${string}`): LeanDirectInvocationV10 => ({ schemaVersion: "v1.38-lean-runner-direct-invocation-v10", authorizationRoot: hashLeanValue(authorization), validityReviewRoot: hashLeanValue(review), preflightRoot: authorization.containerPreflight.root, sourceCommit: authorization.source.commit, childCapabilityRoot, claimClass: "fixture_feasibility_only", invocationOrdinal: 1, authority: LEAN_AUTHORITY_FALSE })
const validateLeanDirectInvocationV10 = (repoRoot: string, value: unknown): LeanDirectInvocationV10 => { const { authorization, review } = loadAndCheckLeanDirectReviewedReadyV10(repoRoot, [LEAN_DIRECT_V10_ARTIFACT_PATHS.invocation]); if (!isObject(value) || !isSha(value.childCapabilityRoot) || JSON.stringify(value) !== JSON.stringify(createLeanDirectInvocationV10(authorization, review, value.childCapabilityRoot))) throw new TypeError("LEAN_DIRECT_V10_INVOCATION_INVALID"); return globalThis.structuredClone(value) as unknown as LeanDirectInvocationV10 }
export const createExclusiveLeanDirectInvocationV10 = (repoRoot: string, invocation: LeanDirectInvocationV10): void => { validateLeanDirectInvocationV10(repoRoot, invocation); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.invocation), invocation) }
export const createLeanDirectTerminalArtifactV10 = (invocation: LeanDirectInvocationV10, terminal: LeanTerminal): LeanDirectTerminalArtifactV10 => ({ schemaVersion: "v1.38-lean-runner-direct-terminal-v10", authorizationRoot: invocation.authorizationRoot, validityReviewRoot: invocation.validityReviewRoot, preflightRoot: invocation.preflightRoot, sourceCommit: invocation.sourceCommit, childCapabilityRoot: invocation.childCapabilityRoot, invocationRoot: hashLeanValue(invocation), privacy: "safe_aggregate_only", terminal: deriveAndValidateLeanTerminal(terminal), authority: LEAN_AUTHORITY_FALSE })
export const createExclusiveLeanDirectTerminalV10 = (repoRoot: string, terminal: LeanDirectTerminalArtifactV10): void => writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.terminal), terminal)
export const checkLeanDirectPostRunV10 = (repoRoot: string): { invocation: LeanDirectInvocationV10; terminal?: LeanDirectTerminalArtifactV10; markerOnly: boolean } => { const invocation = validateLeanDirectInvocationV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.invocation)); if (!existsSync(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.terminal))) return { invocation, markerOnly: true }; const value = readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.terminal); const expected = createLeanDirectTerminalArtifactV10(invocation, (value as LeanDirectTerminalArtifactV10).terminal); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V10_TERMINAL_INVALID"); return { invocation, terminal: value as LeanDirectTerminalArtifactV10, markerOnly: false } }
export const createLeanDirectAdjudicationV10 = (invocation: LeanDirectInvocationV10, terminal?: LeanDirectTerminalArtifactV10): Record<string, unknown> => { const markerOnly = terminal === undefined; const result = markerOnly ? "invalid" : deriveAndValidateLeanTerminal(terminal.terminal).result; return { schemaVersion: "v1.38-lean-runner-direct-adjudication-v10", invocationRoot: hashLeanValue(invocation), terminalRoot: terminal === undefined ? null : hashLeanValue(terminal), reviewedResult: result, markerOnly, opportunityConsumed: true, admitsEligibility: result === "pass", authority: LEAN_AUTHORITY_FALSE } }
export const createLeanDirectEligibilityV10 = (adjudication: Record<string, unknown>): Record<string, unknown> => { const passed = adjudication.reviewedResult === "pass"; return { schemaVersion: "v1.38-phase-262-lean-direct-eligibility-v10", adjudicationRoot: hashLeanValue(adjudication), admit03: passed ? "satisfied_under_revised_contract" : "blocked", phase262Complete: passed, phase263PlanningEligible: passed, phase263ExecutionEligible: passed, authority: { ...LEAN_AUTHORITY_FALSE, phase263PlanningAuthorized: passed, phase263ExecutionAuthorized: passed, candidateSearchAuthorized: passed, foundationActivationAuthorized: passed } } }
export const writeLeanDirectAdjudicationAndEligibilityV10 = (repoRoot: string): void => { const { invocation, terminal } = checkLeanDirectPostRunV10(repoRoot); const adjudication = createLeanDirectAdjudicationV10(invocation, terminal); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.adjudication), adjudication); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.eligibility), createLeanDirectEligibilityV10(adjudication)) }
export const checkLeanDirectAdjudicationV10 = (repoRoot: string): void => { const { invocation, terminal, markerOnly } = checkLeanDirectPostRunV10(repoRoot); const adjudication = readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.adjudication); const expected = createLeanDirectAdjudicationV10(invocation, terminal); if (JSON.stringify(adjudication) !== JSON.stringify(expected) || (adjudication as Record<string, unknown>).markerOnly !== markerOnly) throw new TypeError("LEAN_DIRECT_V10_ADJUDICATION_INVALID"); const eligibility = readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.eligibility); if (JSON.stringify(eligibility) !== JSON.stringify(createLeanDirectEligibilityV10(expected))) throw new TypeError("LEAN_DIRECT_V10_ELIGIBILITY_INVALID") }
export const checkLeanDirectFinalTrackingV10 = (repoRoot: string): void => { checkLeanDirectAdjudicationV10(repoRoot); const eligibility = readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.eligibility) as Record<string, unknown>; for (const trackingPath of [".planning/REQUIREMENTS.md", ".planning/ROADMAP.md", ".planning/STATE.md", ".planning/v1.38-CURRENT-STATUS.md", ".planning/v1.38-v1.38-MILESTONE-AUDIT.md"] as const) if (parseLeanTrackingSurface(trackingPath, readFileSync(path.resolve(repoRoot, trackingPath), "utf8")).admit03 !== eligibility.admit03) throw new TypeError(`LEAN_DIRECT_V10_TRACKING_DRIFT:${trackingPath}`); for (const evidencePath of [".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-VALIDATION.md", ".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-VERIFICATION.md", ".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-UAT.md"]) if (!existsSync(path.resolve(repoRoot, evidencePath))) throw new TypeError(`LEAN_DIRECT_V10_TRACKING_MISSING:${evidencePath}`) }
...
const assertLeanDirectV11PathsAreFresh = (): void => {
  ...
  const fresh = [...Object.values(LEAN_DIRECT_V11_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH]
  if (new Set(fresh).size !== fresh.length || fresh.some((candidate) => historical.includes(candidate as never))) throw new TypeError("LEAN_DIRECT_V11_PATH_ALIAS")
}
const resolveLeanDirectV11Source = (repoRoot: string, explicitRef: string, rejectCurrentHead: boolean): LeanManifest["source"] => resolveLeanDirectV10Source(repoRoot, explicitRef, rejectCurrentHead)
const assertLeanDirectV11TrackedBytes = (repoRoot: string, sourceCommit: string): void => {
  try { execFileSync("git", ["merge-base", "--is-ancestor", LEAN_DIRECT_TUPLE_REPAIR_COMMIT, sourceCommit], { cwd: repoRoot, stdio: "ignore" }); execFileSync("git", ["diff", "--quiet", sourceCommit, "--", ...LEAN_DIRECT_V4_EXECUTABLE_CLOSURE_PATHS], { cwd: repoRoot, stdio: "ignore" }) } catch { throw new TypeError("LEAN_DIRECT_V11_TRACKED_BYTES_DRIFT") }
  const source = git(repoRoot, ["show", `${sourceCommit}:scripts/check-v1-38-lean-admission.ts`])
  if (!source.includes('(stdout === "[]\\n" && stderr === `Error: No such object: ${name}\\n`)') || !source.includes("error === undefined")) throw new TypeError("LEAN_DIRECT_V11_EXACT_ABSENCE_DRIFT")
  assertLeanPersistentStreamSource(repoRoot, sourceCommit); assertLeanDirectV8ExactAbsenceSource(repoRoot, sourceCommit); assertLeanDirectWorkerLifecycleSource(repoRoot, sourceCommit)
}
const buildLeanWorkerLifecycleDiagnosticV2 = (repoRoot: string, explicitSourceRef: string, observed: Omit<LeanWorkerLifecycleDiagnosticV2, "schemaVersion" | "sourceCommit" | "sourceTree" | "executableClosureRoot" | "image" | "controlsRoot" | "attemptOrdinal" | "attemptLimit" | "preflightInvocations" | "matchInvocations" | "authority">): LeanWorkerLifecycleDiagnosticV2 => {
  const source = resolveLeanDirectV11Source(repoRoot, explicitSourceRef, false)
  return { schemaVersion: "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v2", sourceCommit: source.commit, sourceTree: source.tree, executableClosureRoot: hashLeanValue(source.executableBlobs), image: LEAN_CONTAINER_IMAGE, controlsRoot: hashLeanValue(LEAN_CONTAINER_CONTROLS), attemptOrdinal: 3, attemptLimit: 10, ...observed, preflightInvocations: 0, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE }
}
export const validateLeanWorkerLifecycleDiagnosticV2 = (repoRoot: string, value: unknown): LeanWorkerLifecycleDiagnosticV2 => {
  assertPrivacySafe(value)
  if (!isObject(value) || !exactKeys(value, ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "image", "controlsRoot", "attemptOrdinal", "attemptLimit", "stage", "requestCounts", "elapsedMilliseconds", "streamClosed", "cleanupComplete", "preflightInvocations", "matchInvocations", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v2" || !isOid(value.sourceCommit) || !isOid(value.sourceTree) || !isSha(value.executableClosureRoot) || value.image !== LEAN_CONTAINER_IMAGE || value.controlsRoot !== hashLeanValue(LEAN_CONTAINER_CONTROLS) || value.attemptOrdinal !== 3 || value.attemptLimit !== 10 || !["pass", "docker_unavailable", "image_invalid", "broker_failed", "cleanup_incomplete", "unexpected_failure"].includes(String(value.stage)) || !isObject(value.requestCounts) || !exactKeys(value.requestCounts, ["legacy", "v117", "successful"]) || value.requestCounts.legacy !== 1 || value.requestCounts.v117 !== 1 || !Number.isSafeInteger(value.requestCounts.successful) || (value.requestCounts.successful as number) < 0 || (value.requestCounts.successful as number) > 2 || typeof value.elapsedMilliseconds !== "number" || !Number.isFinite(value.elapsedMilliseconds) || value.elapsedMilliseconds < 0 || typeof value.streamClosed !== "boolean" || typeof value.cleanupComplete !== "boolean" || value.preflightInvocations !== 0 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_INVALID")
  const source = resolveLeanDirectV11Source(repoRoot, value.sourceCommit, false); if (value.sourceTree !== source.tree || value.executableClosureRoot !== hashLeanValue(source.executableBlobs)) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_SOURCE_DRIFT")
  if (value.stage === "pass" ? value.requestCounts.successful !== 2 || value.streamClosed !== true || value.cleanupComplete !== true : value.requestCounts.successful === 2 && value.streamClosed === true && value.cleanupComplete === true) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_DISPOSITION_INVALID")
  return globalThis.structuredClone(value) as unknown as LeanWorkerLifecycleDiagnosticV2
}
export const writeLeanDirectWorkerLifecycleDiagnosticV2 = (repoRoot: string, explicitSourceRef: string): LeanWorkerLifecycleDiagnosticV2 => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectPlan192History(repoRoot); assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectV11PathsAreFresh(); for (const artifactPath of [...Object.values(LEAN_DIRECT_V11_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V11_DESTINATION_EXISTS:${artifactPath}`)
  const sourceRef = validateLeanDirectV2ExplicitSourceRef(explicitSourceRef); const source = resolveLeanDirectV11Source(repoRoot, sourceRef, false); assertLeanDirectV11TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot)
  const name = `cg-v138-lifecycle-v2-${source.commit.slice(0, 12)}`; const started = process.hrtime.bigint(); let stage: LeanWorkerLifecycleDiagnosticV2["stage"] = "unexpected_failure"; let successful = 0; let streamClosed = false; let cleanupComplete = false; let created = false
  try {
    const image = diagnosticDocker(["image", "inspect", "--format", "{{json .RepoDigests}}", LEAN_CONTAINER_IMAGE]); if (image.error !== undefined || image.status !== 0 || image.signal !== null || !String(image.stdout).includes(LEAN_CONTAINER_IMAGE.slice(LEAN_CONTAINER_IMAGE.indexOf("@")))) throw new TypeError("image_invalid")
    const absent = diagnosticDocker(["inspect", name]); if (!exactDockerAbsentDiagnostic(absent.status, absent.signal, absent.error, String(absent.stdout), String(absent.stderr), name)) throw new TypeError("docker_unavailable")
    const createdResult = diagnosticDocker(["create", "--name", name, "--label", `v1.38-lean-owner=diagnostic-v2:${source.commit}`, "--interactive", "--network", "none", "--read-only", "--tmpfs", "/tmp:rw,noexec,nosuid,size=16m", "--memory", "64m", "--cpus", "0.5", "--pids-limit", "64", "--cap-drop", "ALL", "--security-opt", "no-new-privileges", "--env", "NODE_ENV=production", "--workdir", "/tmp", LEAN_CONTAINER_IMAGE, "node", "--input-type=module", "--eval", "process.stdin.resume();setInterval(()=>{},2147483647)"]); if (createdResult.error !== undefined || createdResult.status !== 0 || createdResult.signal !== null || String(createdResult.stderr) !== "") throw new TypeError("docker_unavailable"); created = true
    const startedResult = diagnosticDocker(["start", name]); if (startedResult.error !== undefined || startedResult.status !== 0 || startedResult.signal !== null || String(startedResult.stderr) !== "") throw new TypeError("docker_unavailable")
    const input = [diagnosticRequest(1, "legacy"), diagnosticRequest(2, "v117")].map((request) => JSON.stringify(request)).join("\n") + "\n"; const broker = diagnosticDocker(["exec", "-i", name, "node", "--input-type=module", "--eval", LEAN_CONTAINER_BROKER_SOURCE], input); streamClosed = broker.error === undefined && broker.status === 0 && broker.signal === null && String(broker.stderr) === ""
    if (!streamClosed) throw new TypeError("broker_failed"); const lines = String(broker.stdout).trim().split("\n"); if (lines.length !== 2) throw new TypeError("broker_failed"); const frames = lines.map((line) => JSON.parse(line) as Record<string, unknown>); if (frames.some((frame, index) => frame.requestId !== index + 1 || frame.status !== 0 || frame.signal !== null || frame.stderrBase64 !== "" || typeof frame.stdoutBase64 !== "string")) throw new TypeError("broker_failed")
    const legacy = JSON.parse(Buffer.from(frames[0]!.stdoutBase64 as string, "base64").toString("utf8")) as unknown; const v117 = Buffer.from(frames[1]!.stdoutBase64 as string, "base64"); if (!isObject(legacy) || legacy.ok !== true || !Array.isArray(legacy.value) || v117.subarray(0, 4).toString("ascii") !== "CG17" || v117.subarray(24, 25).toString("ascii") !== "S") throw new TypeError("broker_failed"); successful = 2; stage = "pass"
  } catch (error) { const code = error instanceof Error ? error.message : "unexpected_failure"; stage = ["docker_unavailable", "image_invalid", "broker_failed"].includes(code) ? code as LeanWorkerLifecycleDiagnosticV2["stage"] : "unexpected_failure" }
  finally { if (created) { const removed = diagnosticDocker(["rm", "--force", name]); const absent = diagnosticDocker(["inspect", name]); cleanupComplete = removed.error === undefined && removed.status === 0 && removed.signal === null && exactDockerAbsentDiagnostic(absent.status, absent.signal, absent.error, String(absent.stdout), String(absent.stderr), name) } else cleanupComplete = true; if (!cleanupComplete) stage = "cleanup_incomplete" }
  const diagnostic = buildLeanWorkerLifecycleDiagnosticV2(repoRoot, sourceRef, { stage, requestCounts: { legacy: 1, v117: 1, successful }, elapsedMilliseconds: Number(process.hrtime.bigint() - started) / 1_000_000, streamClosed, cleanupComplete }); validateLeanWorkerLifecycleDiagnosticV2(repoRoot, diagnostic); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH), diagnostic); return diagnostic
}
export const checkLeanDirectWorkerLifecycleDiagnosticV2 = (repoRoot: string): LeanWorkerLifecycleDiagnosticV2 => { assertLeanDirectDiagnosticV1History(repoRoot); const diagnostic = validateLeanWorkerLifecycleDiagnosticV2(repoRoot, readJson(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH)); assertLeanDirectV11TrackedBytes(repoRoot, diagnostic.sourceCommit); assertSuccessorLockInventory(repoRoot); return diagnostic }
export const checkLeanDirectWorkerLifecycleSourceOnlyV11 = (repoRoot: string): void => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); checkLeanFirstEvidenceCustody(repoRoot); assertDeniedDirectV1History(repoRoot); assertLeanDirectPlan178History(repoRoot); assertLeanDirectPlan180History(repoRoot); assertLeanDirectPlan182History(repoRoot); assertLeanDirectPlan184History(repoRoot); assertLeanDirectPlan186History(repoRoot); assertLeanDirectPlan190History(repoRoot); assertLeanDirectPlan192History(repoRoot); assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectV11PathsAreFresh()
  for (const artifactPath of [...Object.values(LEAN_DIRECT_V11_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V11_DESTINATION_EXISTS:${artifactPath}`)
  const latest = git(repoRoot, ["log", "-1", "--format=%H", "--", ...LEAN_PLAN177_RUNNABLE_PATHS]); const source = resolveLeanDirectV11Source(repoRoot, latest, false); if (source.commit !== latest || Object.keys(source.executableBlobs).length !== 29) throw new TypeError("LEAN_DIRECT_V11_SOURCE_DRIFT"); assertLeanDirectV11TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot)
}
const buildLeanContainerPreflightArtifactV10 = (repoRoot: string, explicitSourceRef: string, outcome: unknown): LeanContainerPreflightArtifactV10 => { const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV2(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V11_DIAGNOSTIC_NOT_PASS"); const source = resolveLeanDirectV11Source(repoRoot, explicitSourceRef, true); if (diagnostic.sourceCommit !== source.commit || diagnostic.sourceTree !== source.tree || diagnostic.executableClosureRoot !== hashLeanValue(source.executableBlobs)) throw new TypeError("LEAN_DIRECT_V11_DIAGNOSTIC_SOURCE_DRIFT"); return { schemaVersion: "v1.38-lean-runner-direct-container-preflight-v10", sourceCommit: source.commit, sourceTree: source.tree, executableClosureRoot: hashLeanValue(source.executableBlobs), preflight: validateLeanContainerPreflightOutcomeV4(outcome), consuming: false, preflightInvocations: 1, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE } }
export const renderLeanContainerPreflightArtifactV10 = (repoRoot: string, explicitSourceRef: string, outcome: unknown): LeanContainerPreflightArtifactV10 => { assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectV11PathsAreFresh(); return buildLeanContainerPreflightArtifactV10(repoRoot, explicitSourceRef, outcome) }
export const validateLeanContainerPreflightArtifactV10 = (repoRoot: string, value: unknown): LeanContainerPreflightArtifactV10 => { assertPrivacySafe(value); if (!isObject(value) || !exactKeys(value, ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "preflight", "consuming", "preflightInvocations", "matchInvocations", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-container-preflight-v10" || !isOid(value.sourceCommit) || !isOid(value.sourceTree) || !isSha(value.executableClosureRoot) || value.consuming !== false || value.preflightInvocations !== 1 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V11_PREFLIGHT_INVALID"); const expected = buildLeanContainerPreflightArtifactV10(repoRoot, value.sourceCommit, value.preflight); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V11_PREFLIGHT_DRIFT"); return globalThis.structuredClone(value) as unknown as LeanContainerPreflightArtifactV10 }
export const writeLeanContainerPreflightArtifactV10 = (repoRoot: string, explicitSourceRef: string): LeanContainerPreflightArtifactV10 => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectV11PathsAreFresh(); const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV2(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V11_DIAGNOSTIC_NOT_PASS"); for (const artifactPath of Object.values(LEAN_DIRECT_V11_ARTIFACT_PATHS)) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V11_DESTINATION_EXISTS:${artifactPath}`); const sourceRef = validateLeanDirectV2ExplicitSourceRef(explicitSourceRef); const source = resolveLeanDirectV11Source(repoRoot, sourceRef, true); assertLeanDirectV11TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot); let outcome: LeanContainerPreflightOutcomeV4; try { outcome = runActualLeanContainerPreflight() } catch (error) { outcome = { status: "non_pass", reasonCode: classifyLeanContainerPreflightFailure(error) } }; const artifact = renderLeanContainerPreflightArtifactV10(repoRoot, sourceRef, outcome); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight), artifact); return artifact }
const buildLeanDirectAuthorizationV11 = (repoRoot: string, explicitSourceRef: string, preflight: LeanContainerPreflightArtifactV10): LeanDirectAuthorizationV11 => { if (preflight.preflight.status !== "pass") throw new TypeError("LEAN_DIRECT_V11_PREFLIGHT_NOT_PASS"); const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV2(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V11_DIAGNOSTIC_NOT_PASS"); const prior = assertLeanDirectDiagnosticV1History(repoRoot); const source = resolveLeanDirectV11Source(repoRoot, explicitSourceRef, true); if (preflight.sourceCommit !== source.commit || preflight.sourceTree !== source.tree || preflight.executableClosureRoot !== hashLeanValue(source.executableBlobs) || diagnostic.sourceCommit !== source.commit) throw new TypeError("LEAN_DIRECT_V11_SOURCE_DRIFT"); const base = buildLeanDirectAuthorizationV9(repoRoot, source.commit, { ...preflight, schemaVersion: "v1.38-lean-runner-direct-container-preflight-v8" } as LeanContainerPreflightArtifactV8); return { ...base, schemaVersion: "v1.38-lean-runner-direct-authorization-v11", source, containerPreflight: { path: LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight, root: hashLeanValue(preflight) }, workerLifecycleDiagnostic: { path: LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH, root: hashLeanValue(diagnostic), status: "pass" }, diagnosticV1History: { path: LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH, root: hashLeanValue(prior), status: "docker_unavailable_preserved" }, plan192History: { preflightPath: LEAN_DIRECT_V9_ARTIFACT_PATHS.preflight, preflightSha256: `sha256:${LEAN_DIRECT_PLAN192_PREFLIGHT_SHA256}`, reviewPath: LEAN_DIRECT_V9_ARTIFACT_PATHS.review, reviewSha256: `sha256:${LEAN_DIRECT_PLAN192_REVIEW_SHA256}`, status: "non_pass_preserved" } } }
export const renderLeanDirectAuthorizationV11 = (repoRoot: string, explicitSourceRef: string): LeanDirectAuthorizationV11 => { const preflight = validateLeanContainerPreflightArtifactV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight)); for (const artifactPath of Object.values(LEAN_DIRECT_V11_ARTIFACT_PATHS).filter((candidate) => candidate !== LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight)) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V11_DESTINATION_EXISTS:${artifactPath}`); return buildLeanDirectAuthorizationV11(repoRoot, validateLeanDirectV2ExplicitSourceRef(explicitSourceRef), preflight) }
export const validateLeanDirectAuthorizationV11 = (repoRoot: string, value: unknown): LeanDirectAuthorizationV11 => { assertPrivacySafe(value); if (!isObject(value) || value.schemaVersion !== "v1.38-lean-runner-direct-authorization-v11" || !isObject(value.source) || !isOid(value.source.commit) || value.recoveryAuthorized !== false || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V11_AUTHORIZATION_INVALID"); const expected = buildLeanDirectAuthorizationV11(repoRoot, value.source.commit, validateLeanContainerPreflightArtifactV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight))); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V11_AUTHORIZATION_DRIFT"); return globalThis.structuredClone(value) as unknown as LeanDirectAuthorizationV11 }
export const checkLeanDirectAuthorizationV11 = (repoRoot: string, value: unknown): LeanDirectAuthorizationV11 => { const authorization = validateLeanDirectAuthorizationV11(repoRoot, value); assertLeanDirectV11TrackedBytes(repoRoot, authorization.source.commit); assertSuccessorLockInventory(repoRoot); return authorization }
export const writeLeanDirectAuthorizationV11 = (repoRoot: string, explicitSourceRef: string): LeanDirectAuthorizationV11 => { const authorization = renderLeanDirectAuthorizationV11(repoRoot, explicitSourceRef); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.authorization), authorization); return authorization }
export const checkLeanDirectValidityReviewV11 = (repoRoot: string, value: unknown): LeanDirectValidityReviewV11 => { assertPrivacySafe(value); const preflight = validateLeanContainerPreflightArtifactV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight)); const authorizationPresent = existsSync(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.authorization)); const authorization = authorizationPresent ? checkLeanDirectAuthorizationV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.authorization)) : undefined; if (!isObject(value) || !exactKeys(value, ["schemaVersion", "authorizationRoot", "preflightRoot", "sourceCommit", "sourceTree", "categories", "blockingFindingCount", "certificationOnlyHistory", "admitsPlan175", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-validity-review-v11" || value.authorizationRoot !== (authorization === undefined ? null : hashLeanValue(authorization)) || value.preflightRoot !== hashLeanValue(preflight) || value.sourceCommit !== preflight.sourceCommit || value.sourceTree !== preflight.sourceTree || !Array.isArray(value.categories) || value.categories.length !== LEAN_DIRECT_VALIDITY_CATEGORIES.length || !Number.isSafeInteger(value.blockingFindingCount) || (value.blockingFindingCount as number) < 0 || JSON.stringify(value.certificationOnlyHistory) !== JSON.stringify(plan172Findings(repoRoot)) || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V11_REVIEW_INVALID"); for (const [index, category] of LEAN_DIRECT_VALIDITY_CATEGORIES.entries()) { const item = value.categories[index]; if (!isObject(item) || !exactKeys(item, ["category", "status", "evidence"]) || item.category !== category || !["pass", "finding"].includes(String(item.status)) || typeof item.evidence !== "string" || item.evidence.length === 0) throw new TypeError("LEAN_DIRECT_V11_REVIEW_INVALID") }; const findings = value.categories.filter((item) => isObject(item) && item.status === "finding").length; const admitted = preflight.preflight.status === "pass" && authorization !== undefined && findings === 0; if (value.blockingFindingCount !== findings || value.admitsPlan175 !== admitted) throw new TypeError("LEAN_DIRECT_V11_REVIEW_INVALID"); return globalThis.structuredClone(value) as unknown as LeanDirectValidityReviewV11 }
export const loadAndCheckLeanDirectReviewedReadyV11 = (repoRoot: string, allowedOperationalPaths: readonly string[] = []): { authorization: LeanDirectAuthorizationV11; review: LeanDirectValidityReviewV11; preflight: LeanContainerPreflightArtifactV10 } => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"]), allowedOperationalPaths); for (const artifactPath of [LEAN_DIRECT_V11_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V11_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V11_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V11_ARTIFACT_PATHS.eligibility]) if (!allowedOperationalPaths.includes(artifactPath) && existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V11_EFFECT_EXISTS:${artifactPath}`); const preflight = validateLeanContainerPreflightArtifactV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight)); if (preflight.preflight.status !== "pass") throw new TypeError("LEAN_DIRECT_V11_PREFLIGHT_NOT_PASS"); const authorization = checkLeanDirectAuthorizationV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.authorization)); const review = checkLeanDirectValidityReviewV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.review)); if (!review.admitsPlan175 || review.blockingFindingCount !== 0) throw new TypeError("LEAN_DIRECT_V11_PLAN175_NOT_ADMITTED"); return { authorization, review, preflight } }
export const checkLeanDirectReviewDispositionV11 = (repoRoot: string): LeanDirectValidityReviewV11 => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"]), [LEAN_DIRECT_V11_ARTIFACT_PATHS.review]); const review = checkLeanDirectValidityReviewV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.review)); if (review.admitsPlan175) loadAndCheckLeanDirectReviewedReadyV11(repoRoot); else { for (const artifactPath of [LEAN_DIRECT_V11_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V11_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V11_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V11_ARTIFACT_PATHS.eligibility]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V11_DENIED_EFFECT:${artifactPath}`); if (Object.values(review.authority).some(Boolean)) throw new TypeError("LEAN_DIRECT_V11_DENIED_AUTHORITY") }; return review }
export const createLeanDirectInvocationV11 = (authorization: LeanDirectAuthorizationV11, review: LeanDirectValidityReviewV11, childCapabilityRoot: `sha256:${string}`): LeanDirectInvocationV11 => ({ schemaVersion: "v1.38-lean-runner-direct-invocation-v11", authorizationRoot: hashLeanValue(authorization), validityReviewRoot: hashLeanValue(review), preflightRoot: authorization.containerPreflight.root, sourceCommit: authorization.source.commit, childCapabilityRoot, claimClass: "fixture_feasibility_only", invocationOrdinal: 1, authority: LEAN_AUTHORITY_FALSE })
const validateLeanDirectInvocationV11 = (repoRoot: string, value: unknown): LeanDirectInvocationV11 => { const { authorization, review } = loadAndCheckLeanDirectReviewedReadyV11(repoRoot, [LEAN_DIRECT_V11_ARTIFACT_PATHS.invocation]); if (!isObject(value) || !isSha(value.childCapabilityRoot) || JSON.stringify(value) !== JSON.stringify(createLeanDirectInvocationV11(authorization, review, value.childCapabilityRoot))) throw new TypeError("LEAN_DIRECT_V11_INVOCATION_INVALID"); return globalThis.structuredClone(value) as unknown as LeanDirectInvocationV11 }
export const createExclusiveLeanDirectInvocationV11 = (repoRoot: string, invocation: LeanDirectInvocationV11): void => { validateLeanDirectInvocationV11(repoRoot, invocation); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.invocation), invocation) }
export const createLeanDirectTerminalArtifactV11 = (invocation: LeanDirectInvocationV11, terminal: LeanTerminal): LeanDirectTerminalArtifactV11 => ({ schemaVersion: "v1.38-lean-runner-direct-terminal-v11", authorizationRoot: invocation.authorizationRoot, validityReviewRoot: invocation.validityReviewRoot, preflightRoot: invocation.preflightRoot, sourceCommit: invocation.sourceCommit, childCapabilityRoot: invocation.childCapabilityRoot, invocationRoot: hashLeanValue(invocation), privacy: "safe_aggregate_only", terminal: deriveAndValidateLeanTerminal(terminal), authority: LEAN_AUTHORITY_FALSE })
export const createExclusiveLeanDirectTerminalV11 = (repoRoot: string, terminal: LeanDirectTerminalArtifactV11): void => writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.terminal), terminal)
export const checkLeanDirectPostRunV11 = (repoRoot: string): { invocation: LeanDirectInvocationV11; terminal?: LeanDirectTerminalArtifactV11; markerOnly: boolean } => { const invocation = validateLeanDirectInvocationV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.invocation)); if (!existsSync(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.terminal))) return { invocation, markerOnly: true }; const value = readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.terminal); const expected = createLeanDirectTerminalArtifactV11(invocation, (value as LeanDirectTerminalArtifactV11).terminal); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V11_TERMINAL_INVALID"); return { invocation, terminal: value as LeanDirectTerminalArtifactV11, markerOnly: false } }
export const createLeanDirectAdjudicationV11 = (invocation: LeanDirectInvocationV11, terminal?: LeanDirectTerminalArtifactV11): Record<string, unknown> => { const markerOnly = terminal === undefined; const result = markerOnly ? "invalid" : deriveAndValidateLeanTerminal(terminal.terminal).result; return { schemaVersion: "v1.38-lean-runner-direct-adjudication-v11", invocationRoot: hashLeanValue(invocation), terminalRoot: terminal === undefined ? null : hashLeanValue(terminal), reviewedResult: result, markerOnly, opportunityConsumed: true, admitsEligibility: result === "pass", authority: LEAN_AUTHORITY_FALSE } }
export const createLeanDirectEligibilityV11 = (adjudication: Record<string, unknown>): Record<string, unknown> => { const passed = adjudication.reviewedResult === "pass"; return { schemaVersion: "v1.38-phase-262-lean-direct-eligibility-v11", adjudicationRoot: hashLeanValue(adjudication), admit03: passed ? "satisfied_under_revised_contract" : "blocked", phase262Complete: passed, phase263PlanningEligible: passed, phase263ExecutionEligible: passed, authority: { ...LEAN_AUTHORITY_FALSE, phase263PlanningAuthorized: passed, phase263ExecutionAuthorized: passed, candidateSearchAuthorized: passed, foundationActivationAuthorized: passed } } }
export const writeLeanDirectAdjudicationAndEligibilityV11 = (repoRoot: string): void => { const { invocation, terminal } = checkLeanDirectPostRunV11(repoRoot); const adjudication = createLeanDirectAdjudicationV11(invocation, terminal); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.adjudication), adjudication); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.eligibility), createLeanDirectEligibilityV11(adjudication)) }
export const checkLeanDirectAdjudicationV11 = (repoRoot: string): void => { const { invocation, terminal, markerOnly } = checkLeanDirectPostRunV11(repoRoot); const adjudication = readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.adjudication); const expected = createLeanDirectAdjudicationV11(invocation, terminal); if (JSON.stringify(adjudication) !== JSON.stringify(expected) || (adjudication as Record<string, unknown>).markerOnly !== markerOnly) throw new TypeError("LEAN_DIRECT_V11_ADJUDICATION_INVALID"); const eligibility = readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.eligibility); if (JSON.stringify(eligibility) !== JSON.stringify(createLeanDirectEligibilityV11(expected))) throw new TypeError("LEAN_DIRECT_V11_ELIGIBILITY_INVALID") }
export const checkLeanDirectFinalTrackingV11 = (repoRoot: string): void => { checkLeanDirectAdjudicationV11(repoRoot); const eligibility = readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.eligibility) as Record<string, unknown>; for (const trackingPath of [".planning/REQUIREMENTS.md", ".planning/ROADMAP.md", ".planning/STATE.md", ".planning/v1.38-CURRENT-STATUS.md", ".planning/v1.38-v1.38-MILESTONE-AUDIT.md"] as const) if (parseLeanTrackingSurface(trackingPath, readFileSync(path.resolve(repoRoot, trackingPath), "utf8")).admit03 !== eligibility.admit03) throw new TypeError(`LEAN_DIRECT_V11_TRACKING_DRIFT:${trackingPath}`); for (const evidencePath of [".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-VALIDATION.md", ".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-VERIFICATION.md", ".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-UAT.md"]) if (!existsSync(path.resolve(repoRoot, evidencePath))) throw new TypeError(`LEAN_DIRECT_V11_TRACKING_MISSING:${evidencePath}`) }

const LEAN_DIRECT_DOCKER_29_4_TUPLE_REPAIR_COMMIT = "e54784627cc19dfdce8e39ac40604e2e3a8010e6" as const
...
const assertLeanDirectDiagnosticV2History = (repoRoot: string): LeanWorkerLifecycleDiagnosticV2 => {
  const diagnostic = readJson(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH)
  if (hashLeanValue(diagnostic) !== LEAN_DIRECT_DIAGNOSTIC_V2_ROOT || !isObject(diagnostic) || diagnostic.schemaVersion !== "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v2" || diagnostic.stage !== "docker_unavailable" || diagnostic.attemptOrdinal !== 3 || diagnostic.attemptLimit !== 10 || diagnostic.preflightInvocations !== 0 || diagnostic.matchInvocations !== 0 || !exactFalseAuthority(diagnostic.authority)) throw new TypeError("LEAN_DIRECT_DIAGNOSTIC_V2_HISTORY_DRIFT")
  return globalThis.structuredClone(diagnostic) as unknown as LeanWorkerLifecycleDiagnosticV2
}
const assertLeanDirectAttempt4History = (repoRoot: string): void => {
  const bytes = git(repoRoot, ["show", `${LEAN_DIRECT_ATTEMPT4_DEBUG_COMMIT}:${LEAN_DIRECT_DEBUG_PATH}`]) + "\n"
  if (`sha256:${createHash("sha256").update(bytes).digest("hex")}` !== LEAN_DIRECT_ATTEMPT4_DEBUG_SHA256 || !bytes.includes("diagnostic/repair attempt 4 of 10") || !bytes.includes("zero preflights ran, zero Matches ran") || !bytes.includes("all authority remains false")) throw new TypeError("LEAN_DIRECT_ATTEMPT4_HISTORY_DRIFT")
}
const assertLeanDirectV12PathsAreFresh = (): void => {
  const historical = [...Object.values(LEAN_DIRECT_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V2_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V3_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V4_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V5_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V6_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V7_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V8_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V9_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V10_ARTIFACT_PATHS), ...Object.values(LEAN_DIRECT_V11_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH]
  const fresh = [...Object.values(LEAN_DIRECT_V12_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH]
  if (new Set(fresh).size !== fresh.length || fresh.some((candidate) => historical.includes(candidate as never))) throw new TypeError("LEAN_DIRECT_V12_PATH_ALIAS")
}
const resolveLeanDirectV12Source = (repoRoot: string, explicitRef: string, rejectCurrentHead: boolean): LeanManifest["source"] => resolveLeanDirectV11Source(repoRoot, explicitRef, rejectCurrentHead)
const assertLeanDirectV12TrackedBytes = (repoRoot: string, sourceCommit: string): void => {
  try { execFileSync("git", ["merge-base", "--is-ancestor", LEAN_DIRECT_DOCKER_29_4_TUPLE_REPAIR_COMMIT, sourceCommit], { cwd: repoRoot, stdio: "ignore" }); execFileSync("git", ["diff", "--quiet", sourceCommit, "--", ...LEAN_DIRECT_V4_EXECUTABLE_CLOSURE_PATHS], { cwd: repoRoot, stdio: "ignore" }) } catch { throw new TypeError("LEAN_DIRECT_V12_TRACKED_BYTES_DRIFT") }
  const source = git(repoRoot, ["show", `${sourceCommit}:scripts/check-v1-38-lean-admission.ts`])
  for (const token of ['(stdout === "[]\\n" && stderr === `error: no such object: ${name}\\n`)', "error === undefined", "signal === null", "status === 1"]) if (!source.includes(token)) throw new TypeError("LEAN_DIRECT_V12_EXACT_ABSENCE_DRIFT")
  assertLeanPersistentStreamSource(repoRoot, sourceCommit); assertLeanDirectV8ExactAbsenceSource(repoRoot, sourceCommit); assertLeanDirectWorkerLifecycleSource(repoRoot, sourceCommit)
}

const buildLeanWorkerLifecycleDiagnosticV3 = (repoRoot: string, explicitSourceRef: string, observed: Omit<LeanWorkerLifecycleDiagnosticV3, "schemaVersion" | "sourceCommit" | "sourceTree" | "executableClosureRoot" | "image" | "controlsRoot" | "attemptOrdinal" | "attemptLimit" | "preflightInvocations" | "matchInvocations" | "authority">): LeanWorkerLifecycleDiagnosticV3 => {
  const source = resolveLeanDirectV12Source(repoRoot, explicitSourceRef, false)
  return { schemaVersion: "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v3", sourceCommit: source.commit, sourceTree: source.tree, executableClosureRoot: hashLeanValue(source.executableBlobs), image: LEAN_CONTAINER_IMAGE, controlsRoot: hashLeanValue(LEAN_CONTAINER_CONTROLS), attemptOrdinal: 5, attemptLimit: 10, ...observed, preflightInvocations: 0, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE }
}
export const validateLeanWorkerLifecycleDiagnosticV3 = (repoRoot: string, value: unknown): LeanWorkerLifecycleDiagnosticV3 => {
  assertPrivacySafe(value)
  if (!isObject(value) || !exactKeys(value, ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "image", "controlsRoot", "attemptOrdinal", "attemptLimit", "stage", "requestCounts", "elapsedMilliseconds", "streamClosed", "cleanupComplete", "preflightInvocations", "matchInvocations", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-worker-lifecycle-diagnostic-v3" || !isOid(value.sourceCommit) || !isOid(value.sourceTree) || !isSha(value.executableClosureRoot) || value.image !== LEAN_CONTAINER_IMAGE || value.controlsRoot !== hashLeanValue(LEAN_CONTAINER_CONTROLS) || value.attemptOrdinal !== 5 || value.attemptLimit !== 10 || !["pass", "docker_unavailable", "image_invalid", "broker_failed", "cleanup_incomplete", "unexpected_failure"].includes(String(value.stage)) || !isObject(value.requestCounts) || !exactKeys(value.requestCounts, ["legacy", "v117", "successful"]) || value.requestCounts.legacy !== 1 || value.requestCounts.v117 !== 1 || !Number.isSafeInteger(value.requestCounts.successful) || (value.requestCounts.successful as number) < 0 || (value.requestCounts.successful as number) > 2 || typeof value.elapsedMilliseconds !== "number" || !Number.isFinite(value.elapsedMilliseconds) || value.elapsedMilliseconds < 0 || typeof value.streamClosed !== "boolean" || typeof value.cleanupComplete !== "boolean" || value.preflightInvocations !== 0 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_INVALID")
  const source = resolveLeanDirectV12Source(repoRoot, value.sourceCommit, false); if (value.sourceTree !== source.tree || value.executableClosureRoot !== hashLeanValue(source.executableBlobs)) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_SOURCE_DRIFT")
  if (value.stage === "pass" ? value.requestCounts.successful !== 2 || value.streamClosed !== true || value.cleanupComplete !== true : value.requestCounts.successful === 2 && value.streamClosed === true && value.cleanupComplete === true) throw new TypeError("LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_DISPOSITION_INVALID")
  return globalThis.structuredClone(value) as unknown as LeanWorkerLifecycleDiagnosticV3
}
export const writeLeanDirectWorkerLifecycleDiagnosticV3 = (repoRoot: string, explicitSourceRef: string): LeanWorkerLifecycleDiagnosticV3 => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectDiagnosticV2History(repoRoot); assertLeanDirectAttempt4History(repoRoot); assertLeanDirectV12PathsAreFresh(); for (const artifactPath of [...Object.values(LEAN_DIRECT_V12_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V12_DESTINATION_EXISTS:${artifactPath}`)
  const sourceRef = validateLeanDirectV2ExplicitSourceRef(explicitSourceRef); const source = resolveLeanDirectV12Source(repoRoot, sourceRef, false); assertLeanDirectV12TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot)
  const name = `cg-v138-lifecycle-v3-${source.commit.slice(0, 12)}`; const started = process.hrtime.bigint(); let stage: LeanWorkerLifecycleDiagnosticV3["stage"] = "unexpected_failure"; let successful = 0; let streamClosed = false; let cleanupComplete = false; let created = false
  try {
    const image = diagnosticDocker(["image", "inspect", "--format", "{{json .RepoDigests}}", LEAN_CONTAINER_IMAGE]); if (image.error !== undefined || image.status !== 0 || image.signal !== null || !String(image.stdout).includes(LEAN_CONTAINER_IMAGE.slice(LEAN_CONTAINER_IMAGE.indexOf("@")))) throw new TypeError("image_invalid")
    const absent = diagnosticDocker(["inspect", name]); if (!exactDockerAbsentDiagnostic(absent.status, absent.signal, absent.error, String(absent.stdout), String(absent.stderr), name)) throw new TypeError("docker_unavailable")
    const createdResult = diagnosticDocker(["create", "--name", name, "--label", `v1.38-lean-owner=diagnostic-v3:${source.commit}`, "--interactive", "--network", "none", "--read-only", "--tmpfs", "/tmp:rw,noexec,nosuid,size=16m", "--memory", "64m", "--cpus", "0.5", "--pids-limit", "64", "--cap-drop", "ALL", "--security-opt", "no-new-privileges", "--env", "NODE_ENV=production", "--workdir", "/tmp", LEAN_CONTAINER_IMAGE, "node", "--input-type=module", "--eval", "process.stdin.resume();setInterval(()=>{},2147483647)"]); if (createdResult.error !== undefined || createdResult.status !== 0 || createdResult.signal !== null || String(createdResult.stderr) !== "") throw new TypeError("docker_unavailable"); created = true
    const startedResult = diagnosticDocker(["start", name]); if (startedResult.error !== undefined || startedResult.status !== 0 || startedResult.signal !== null || String(startedResult.stderr) !== "") throw new TypeError("docker_unavailable")
    const input = [diagnosticRequest(1, "legacy"), diagnosticRequest(2, "v117")].map((request) => JSON.stringify(request)).join("\n") + "\n"; const broker = diagnosticDocker(["exec", "-i", name, "node", "--input-type=module", "--eval", LEAN_CONTAINER_BROKER_SOURCE], input); streamClosed = broker.error === undefined && broker.status === 0 && broker.signal === null && String(broker.stderr) === ""
    if (!streamClosed) throw new TypeError("broker_failed"); const lines = String(broker.stdout).trim().split("\n"); if (lines.length !== 2) throw new TypeError("broker_failed"); const frames = lines.map((line) => JSON.parse(line) as Record<string, unknown>); if (frames.some((frame, index) => frame.requestId !== index + 1 || frame.status !== 0 || frame.signal !== null || frame.stderrBase64 !== "" || typeof frame.stdoutBase64 !== "string")) throw new TypeError("broker_failed")
    const legacy = JSON.parse(Buffer.from(frames[0]!.stdoutBase64 as string, "base64").toString("utf8")) as unknown; const v117 = Buffer.from(frames[1]!.stdoutBase64 as string, "base64"); if (!isObject(legacy) || legacy.ok !== true || !Array.isArray(legacy.value) || v117.subarray(0, 4).toString("ascii") !== "CG17" || v117.subarray(24, 25).toString("ascii") !== "S") throw new TypeError("broker_failed"); successful = 2; stage = "pass"
  } catch (error) { const code = error instanceof Error ? error.message : "unexpected_failure"; stage = ["docker_unavailable", "image_invalid", "broker_failed"].includes(code) ? code as LeanWorkerLifecycleDiagnosticV3["stage"] : "unexpected_failure" }
  finally { if (created) { const removed = diagnosticDocker(["rm", "--force", name]); const absent = diagnosticDocker(["inspect", name]); cleanupComplete = removed.error === undefined && removed.status === 0 && removed.signal === null && exactDockerAbsentDiagnostic(absent.status, absent.signal, absent.error, String(absent.stdout), String(absent.stderr), name) } else cleanupComplete = true; if (!cleanupComplete) stage = "cleanup_incomplete" }
  const diagnostic = buildLeanWorkerLifecycleDiagnosticV3(repoRoot, sourceRef, { stage, requestCounts: { legacy: 1, v117: 1, successful }, elapsedMilliseconds: Number(process.hrtime.bigint() - started) / 1_000_000, streamClosed, cleanupComplete }); validateLeanWorkerLifecycleDiagnosticV3(repoRoot, diagnostic); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH), diagnostic); return diagnostic
}
export const checkLeanDirectWorkerLifecycleDiagnosticV3 = (repoRoot: string): LeanWorkerLifecycleDiagnosticV3 => { assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectDiagnosticV2History(repoRoot); assertLeanDirectAttempt4History(repoRoot); const diagnostic = validateLeanWorkerLifecycleDiagnosticV3(repoRoot, readJson(repoRoot, LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH)); assertLeanDirectV12TrackedBytes(repoRoot, diagnostic.sourceCommit); assertSuccessorLockInventory(repoRoot); return diagnostic }
export const checkLeanDirectWorkerLifecycleSourceOnlyV12 = (repoRoot: string): void => {
  assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); checkLeanFirstEvidenceCustody(repoRoot); assertDeniedDirectV1History(repoRoot); assertLeanDirectPlan178History(repoRoot); assertLeanDirectPlan180History(repoRoot); assertLeanDirectPlan182History(repoRoot); assertLeanDirectPlan184History(repoRoot); assertLeanDirectPlan186History(repoRoot); assertLeanDirectPlan190History(repoRoot); assertLeanDirectPlan192History(repoRoot); assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectDiagnosticV2History(repoRoot); assertLeanDirectAttempt4History(repoRoot); assertLeanDirectV12PathsAreFresh()
  for (const artifactPath of [...Object.values(LEAN_DIRECT_V12_ARTIFACT_PATHS), LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V12_DESTINATION_EXISTS:${artifactPath}`)
  const latest = git(repoRoot, ["log", "-1", "--format=%H", "--", ...LEAN_PLAN177_RUNNABLE_PATHS]); const source = resolveLeanDirectV12Source(repoRoot, latest, false); if (source.commit !== latest || Object.keys(source.executableBlobs).length !== 29) throw new TypeError("LEAN_DIRECT_V12_SOURCE_DRIFT"); assertLeanDirectV12TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot)
}

const buildLeanContainerPreflightArtifactV11 = (repoRoot: string, explicitSourceRef: string, outcome: unknown): LeanContainerPreflightArtifactV11 => { const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV3(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V12_DIAGNOSTIC_NOT_PASS"); const source = resolveLeanDirectV12Source(repoRoot, explicitSourceRef, true); if (diagnostic.sourceCommit !== source.commit || diagnostic.sourceTree !== source.tree || diagnostic.executableClosureRoot !== hashLeanValue(source.executableBlobs)) throw new TypeError("LEAN_DIRECT_V12_DIAGNOSTIC_SOURCE_DRIFT"); return { schemaVersion: "v1.38-lean-runner-direct-container-preflight-v11", sourceCommit: source.commit, sourceTree: source.tree, executableClosureRoot: hashLeanValue(source.executableBlobs), preflight: validateLeanContainerPreflightOutcomeV4(outcome), consuming: false, preflightInvocations: 1, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE } }
export const renderLeanContainerPreflightArtifactV11 = (repoRoot: string, explicitSourceRef: string, outcome: unknown): LeanContainerPreflightArtifactV11 => { assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectDiagnosticV2History(repoRoot); assertLeanDirectV12PathsAreFresh(); return buildLeanContainerPreflightArtifactV11(repoRoot, explicitSourceRef, outcome) }
export const validateLeanContainerPreflightArtifactV11 = (repoRoot: string, value: unknown): LeanContainerPreflightArtifactV11 => { assertPrivacySafe(value); if (!isObject(value) || !exactKeys(value, ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "preflight", "consuming", "preflightInvocations", "matchInvocations", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-container-preflight-v11" || !isOid(value.sourceCommit) || !isOid(value.sourceTree) || !isSha(value.executableClosureRoot) || value.consuming !== false || value.preflightInvocations !== 1 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V12_PREFLIGHT_INVALID"); const expected = buildLeanContainerPreflightArtifactV11(repoRoot, value.sourceCommit, value.preflight); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V12_PREFLIGHT_DRIFT"); return globalThis.structuredClone(value) as unknown as LeanContainerPreflightArtifactV11 }
export const writeLeanContainerPreflightArtifactV11 = (repoRoot: string, explicitSourceRef: string): LeanContainerPreflightArtifactV11 => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectDiagnosticV1History(repoRoot); assertLeanDirectDiagnosticV2History(repoRoot); assertLeanDirectV12PathsAreFresh(); const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV3(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V12_DIAGNOSTIC_NOT_PASS"); for (const artifactPath of Object.values(LEAN_DIRECT_V12_ARTIFACT_PATHS)) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V12_DESTINATION_EXISTS:${artifactPath}`); const sourceRef = validateLeanDirectV2ExplicitSourceRef(explicitSourceRef); const source = resolveLeanDirectV12Source(repoRoot, sourceRef, true); assertLeanDirectV12TrackedBytes(repoRoot, source.commit); assertSuccessorLockInventory(repoRoot); let outcome: LeanContainerPreflightOutcomeV4; try { outcome = runActualLeanContainerPreflight() } catch (error) { outcome = { status: "non_pass", reasonCode: classifyLeanContainerPreflightFailure(error) } }; const artifact = renderLeanContainerPreflightArtifactV11(repoRoot, sourceRef, outcome); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight), artifact); return artifact }

const buildLeanDirectAuthorizationV12 = (repoRoot: string, explicitSourceRef: string, preflight: LeanContainerPreflightArtifactV11): LeanDirectAuthorizationV12 => {
  if (preflight.preflight.status !== "pass") throw new TypeError("LEAN_DIRECT_V12_PREFLIGHT_NOT_PASS")
  const diagnostic = checkLeanDirectWorkerLifecycleDiagnosticV3(repoRoot); if (diagnostic.stage !== "pass") throw new TypeError("LEAN_DIRECT_V12_DIAGNOSTIC_NOT_PASS")
  const priorV1 = assertLeanDirectDiagnosticV1History(repoRoot); const priorV2 = assertLeanDirectDiagnosticV2History(repoRoot); assertLeanDirectAttempt4History(repoRoot)
  const source = resolveLeanDirectV12Source(repoRoot, explicitSourceRef, true); if (preflight.sourceCommit !== source.commit || preflight.sourceTree !== source.tree || preflight.executableClosureRoot !== hashLeanValue(source.executableBlobs) || diagnostic.sourceCommit !== source.commit) throw new TypeError("LEAN_DIRECT_V12_SOURCE_DRIFT")
  const base = buildLeanDirectAuthorizationV9(repoRoot, source.commit, { ...preflight, schemaVersion: "v1.38-lean-runner-direct-container-preflight-v8" } as LeanContainerPreflightArtifactV8)
  return { ...base, schemaVersion: "v1.38-lean-runner-direct-authorization-v12", source, containerPreflight: { path: LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight, root: hashLeanValue(preflight) }, workerLifecycleDiagnostic: { path: LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V3_PATH, root: hashLeanValue(diagnostic), status: "pass" }, diagnosticV1History: { path: LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_PATH, root: hashLeanValue(priorV1), status: "docker_unavailable_preserved" }, diagnosticV2History: { path: LEAN_DIRECT_WORKER_LIFECYCLE_DIAGNOSTIC_V2_PATH, root: hashLeanValue(priorV2), status: "docker_unavailable_preserved" }, attempt4History: { path: LEAN_DIRECT_DEBUG_PATH, contentSha256: LEAN_DIRECT_ATTEMPT4_DEBUG_SHA256, status: "read_only_zero_effect_preserved" }, correctiveInvocationLimit: 1, correctiveInvocationsConsumed: 0 }
}
export const renderLeanDirectAuthorizationV12 = (repoRoot: string, explicitSourceRef: string): LeanDirectAuthorizationV12 => { const preflight = validateLeanContainerPreflightArtifactV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight)); for (const artifactPath of Object.values(LEAN_DIRECT_V12_ARTIFACT_PATHS).filter((candidate) => candidate !== LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight)) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V12_DESTINATION_EXISTS:${artifactPath}`); return buildLeanDirectAuthorizationV12(repoRoot, validateLeanDirectV2ExplicitSourceRef(explicitSourceRef), preflight) }
export const validateLeanDirectAuthorizationV12 = (repoRoot: string, value: unknown): LeanDirectAuthorizationV12 => { assertPrivacySafe(value); if (!isObject(value) || value.schemaVersion !== "v1.38-lean-runner-direct-authorization-v12" || !isObject(value.source) || !isOid(value.source.commit) || value.recoveryAuthorized !== false || value.correctiveInvocationLimit !== 1 || value.correctiveInvocationsConsumed !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V12_AUTHORIZATION_INVALID"); const expected = buildLeanDirectAuthorizationV12(repoRoot, value.source.commit, validateLeanContainerPreflightArtifactV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight))); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V12_AUTHORIZATION_DRIFT"); return globalThis.structuredClone(value) as unknown as LeanDirectAuthorizationV12 }
export const checkLeanDirectAuthorizationV12 = (repoRoot: string, value: unknown): LeanDirectAuthorizationV12 => { const authorization = validateLeanDirectAuthorizationV12(repoRoot, value); assertLeanDirectV12TrackedBytes(repoRoot, authorization.source.commit); assertSuccessorLockInventory(repoRoot); return authorization }
export const writeLeanDirectAuthorizationV12 = (repoRoot: string, explicitSourceRef: string): LeanDirectAuthorizationV12 => { const authorization = renderLeanDirectAuthorizationV12(repoRoot, explicitSourceRef); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.authorization), authorization); return authorization }
export const checkLeanDirectValidityReviewV12 = (repoRoot: string, value: unknown): LeanDirectValidityReviewV12 => { assertPrivacySafe(value); const preflight = validateLeanContainerPreflightArtifactV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight)); const authorizationPresent = existsSync(path.resolve(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.authorization)); const authorization = authorizationPresent ? checkLeanDirectAuthorizationV12(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.authorization)) : undefined; if (!isObject(value) || !exactKeys(value, ["schemaVersion", "authorizationRoot", "preflightRoot", "sourceCommit", "sourceTree", "categories", "blockingFindingCount", "certificationOnlyHistory", "admitsPlan175", "authority"]) || value.schemaVersion !== "v1.38-lean-runner-direct-validity-review-v12" || value.authorizationRoot !== (authorization === undefined ? null : hashLeanValue(authorization)) || value.preflightRoot !== hashLeanValue(preflight) || value.sourceCommit !== preflight.sourceCommit || value.sourceTree !== preflight.sourceTree || !Array.isArray(value.categories) || value.categories.length !== LEAN_DIRECT_VALIDITY_CATEGORIES.length || !Number.isSafeInteger(value.blockingFindingCount) || (value.blockingFindingCount as number) < 0 || JSON.stringify(value.certificationOnlyHistory) !== JSON.stringify(plan172Findings(repoRoot)) || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_DIRECT_V12_REVIEW_INVALID"); for (const [index, category] of LEAN_DIRECT_VALIDITY_CATEGORIES.entries()) { const item = value.categories[index]; if (!isObject(item) || !exactKeys(item, ["category", "status", "evidence"]) || item.category !== category || !["pass", "finding"].includes(String(item.status)) || typeof item.evidence !== "string" || item.evidence.length === 0) throw new TypeError("LEAN_DIRECT_V12_REVIEW_INVALID") }; const findings = value.categories.filter((item) => isObject(item) && item.status === "finding").length; const admitted = preflight.preflight.status === "pass" && authorization !== undefined && findings === 0; if (value.blockingFindingCount !== findings || value.admitsPlan175 !== admitted) throw new TypeError("LEAN_DIRECT_V12_REVIEW_INVALID"); return globalThis.structuredClone(value) as unknown as LeanDirectValidityReviewV12 }
export const loadAndCheckLeanDirectReviewedReadyV12 = (repoRoot: string, allowedOperationalPaths: readonly string[] = []): { authorization: LeanDirectAuthorizationV12; review: LeanDirectValidityReviewV12; preflight: LeanContainerPreflightArtifactV11 } => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"]), allowedOperationalPaths); for (const artifactPath of [LEAN_DIRECT_V12_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V12_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V12_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V12_ARTIFACT_PATHS.eligibility]) if (!allowedOperationalPaths.includes(artifactPath) && existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V12_EFFECT_EXISTS:${artifactPath}`); const preflight = validateLeanContainerPreflightArtifactV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight)); if (preflight.preflight.status !== "pass") throw new TypeError("LEAN_DIRECT_V12_PREFLIGHT_NOT_PASS"); const authorization = checkLeanDirectAuthorizationV12(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.authorization)); const review = checkLeanDirectValidityReviewV12(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.review)); if (!review.admitsPlan175 || review.blockingFindingCount !== 0) throw new TypeError("LEAN_DIRECT_V12_PLAN175_NOT_ADMITTED"); return { authorization, review, preflight } }
export const checkLeanDirectReviewDispositionV12 = (repoRoot: string): LeanDirectValidityReviewV12 => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"]), [LEAN_DIRECT_V12_ARTIFACT_PATHS.review]); const review = checkLeanDirectValidityReviewV12(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.review)); if (review.admitsPlan175) loadAndCheckLeanDirectReviewedReadyV12(repoRoot); else { for (const artifactPath of [LEAN_DIRECT_V12_ARTIFACT_PATHS.invocation, LEAN_DIRECT_V12_ARTIFACT_PATHS.terminal, LEAN_DIRECT_V12_ARTIFACT_PATHS.adjudication, LEAN_DIRECT_V12_ARTIFACT_PATHS.eligibility]) if (existsSync(path.resolve(repoRoot, artifactPath))) throw new TypeError(`LEAN_DIRECT_V12_DENIED_EFFECT:${artifactPath}`); if (Object.values(review.authority).some(Boolean)) throw new TypeError("LEAN_DIRECT_V12_DENIED_AUTHORITY") }; return review }
export const createLeanDirectInvocationV12 = (authorization: LeanDirectAuthorizationV12, review: LeanDirectValidityReviewV12, childCapabilityRoot: `sha256:${string}`): LeanDirectInvocationV12 => ({ schemaVersion: "v1.38-lean-runner-direct-invocation-v12", authorizationRoot: hashLeanValue(authorization), validityReviewRoot: hashLeanValue(review), preflightRoot: authorization.containerPreflight.root, sourceCommit: authorization.source.commit, childCapabilityRoot, claimClass: "fixture_feasibility_only", invocationOrdinal: 1, authority: LEAN_AUTHORITY_FALSE })
const validateLeanDirectInvocationV12 = (repoRoot: string, value: unknown): LeanDirectInvocationV12 => { const { authorization, review } = loadAndCheckLeanDirectReviewedReadyV12(repoRoot, [LEAN_DIRECT_V12_ARTIFACT_PATHS.invocation]); if (!isObject(value) || !isSha(value.childCapabilityRoot) || JSON.stringify(value) !== JSON.stringify(createLeanDirectInvocationV12(authorization, review, value.childCapabilityRoot))) throw new TypeError("LEAN_DIRECT_V12_INVOCATION_INVALID"); return globalThis.structuredClone(value) as unknown as LeanDirectInvocationV12 }
export const createExclusiveLeanDirectInvocationV12 = (repoRoot: string, invocation: LeanDirectInvocationV12): void => { validateLeanDirectInvocationV12(repoRoot, invocation); writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.invocation), invocation) }
export const createLeanDirectTerminalArtifactV12 = (invocation: LeanDirectInvocationV12, terminal: LeanTerminal): LeanDirectTerminalArtifactV12 => ({ schemaVersion: "v1.38-lean-runner-direct-terminal-v12", authorizationRoot: invocation.authorizationRoot, validityReviewRoot: invocation.validityReviewRoot, preflightRoot: invocation.preflightRoot, sourceCommit: invocation.sourceCommit, childCapabilityRoot: invocation.childCapabilityRoot, invocationRoot: hashLeanValue(invocation), privacy: "safe_aggregate_only", terminal: deriveAndValidateLeanTerminal(terminal), authority: LEAN_AUTHORITY_FALSE })
export const createExclusiveLeanDirectTerminalV12 = (repoRoot: string, terminal: LeanDirectTerminalArtifactV12): void => writeExclusiveDurable(path.resolve(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.terminal), terminal)
export const checkLeanDirectPostRunV12 = (repoRoot: string): { invocation: LeanDirectInvocationV12; terminal?: LeanDirectTerminalArtifactV12; markerOnly: boolean } => { const invocation = validateLeanDirectInvocationV12(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.invocation)); if (!existsSync(path.resolve(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.terminal))) return { invocation, markerOnly: true }; const value = readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.terminal); const expected = createLeanDirectTerminalArtifactV12(invocation, (value as LeanDirectTerminalArtifactV12).terminal); if (JSON.stringify(value) !== JSON.stringify(expected)) throw new TypeError("LEAN_DIRECT_V12_TERMINAL_INVALID"); return { invocation, terminal: value as LeanDirectTerminalArtifactV12, markerOnly: false } }
export const createLeanDirectAdjudicationV12 = (invocation: LeanDirectInvocationV12, terminal?: LeanDirectTerminalArtifactV12): Record<string, unknown> => { const markerOnly = terminal === undefined; const result = markerOnly ? "invalid" : deriveAndValidateLeanTerminal(terminal.terminal).result; return { schemaVersion: "v1.38-lean-runner-direct-adjudication-v12", invocationRoot: hashLeanValue(invocation), terminalRoot: terminal === undefined ? null : hashLeanValue(terminal), reviewedResult: result, markerOnly, opportunityConsumed: true, admitsEligibility: result === "pass", authority: LEAN_AUTHORITY_FALSE } }
export const createLeanDirectEligibilityV12 = (adjudication: Record<string, unknown>): Record<string, unknown> => { const passed = adjudication.reviewedResult === "pass"; return { schemaVersion: "v1.38-phase-262-lean-direct-eligibility-v12", adjudicationRoot: hashLeanValue(adjudication), admit03: passed ? "satisfied_under_revised_contract" : "blocked", phase262Complete: passed, phase263PlanningEligible: passed, phase263ExecutionEligible: passed, authority: { ...LEAN_AUTHORITY_FALSE, phase263PlanningAuthorized: passed, phase263ExecutionAuthorized: passed, candidateSearchAuthorized: passed, foundationActivationAuthorized: passed } } }
...
type LeanActualFixtureResultClass = "player_violation" | "session_failure" | null
...
export interface LeanActualFixtureStageDiagnosticV5 extends Omit<LeanActualFixtureStageDiagnosticV4, "schemaVersion" | "history" | "attemptOrdinal" | "attemptsRemaining"> {
  readonly schemaVersion: "v1.38-lean-runner-direct-actual-fixture-stage-diagnostic-v5"
  readonly history: typeof LEAN_DIRECT_V14_HISTORY
...
const LEAN_DIRECT_V14_PLAN199_COMMIT = "97241136e4279c57c5734a896a886afe31fa327a" as const
const LEAN_DIRECT_V14_PLAN199_SUMMARY_PATH = ".planning/phases/262-foundation-admission-measurement-custody-and-containment-con/262-199-SUMMARY.md" as const
const LEAN_DIRECT_V14_PLAN199_SUMMARY_ROOT = "sha256:16f76622d37a6ad882936377cf81cecf3022067680b8dd45ba68dbb82ea7e5a5" as const
const LEAN_DIRECT_V14_HISTORY = Object.freeze({
  ...LEAN_DIRECT_V13_HISTORY,
  attempt7Commit: LEAN_DIRECT_V14_PLAN199_COMMIT,
  attempt7SummaryRoot: LEAN_DIRECT_V14_PLAN199_SUMMARY_ROOT,
  diagnosticV4Absent: true,
} as const)
const assertLeanDirectAttempt7History = (repoRoot: string): void => {
  if (git(repoRoot, ["rev-parse", `${LEAN_DIRECT_V14_PLAN199_COMMIT}^{commit}`]) !== LEAN_DIRECT_V14_PLAN199_COMMIT) throw new TypeError("LEAN_DIRECT_V13_ATTEMPT_HISTORY_DRIFT")
  try { execFileSync("git", ["merge-base", "--is-ancestor", LEAN_DIRECT_V14_PLAN199_COMMIT, "HEAD"], { cwd: repoRoot, stdio: "ignore" }) } catch { throw new TypeError("LEAN_DIRECT_V13_ATTEMPT_HISTORY_DRIFT") }
  const summaryRoot = `sha256:${createHash("sha256").update(readFileSync(path.resolve(repoRoot, LEAN_DIRECT_V14_PLAN199_SUMMARY_PATH))).digest("hex")}`
  if (summaryRoot !== LEAN_DIRECT_V14_PLAN199_SUMMARY_ROOT) throw new TypeError("LEAN_DIRECT_V13_ATTEMPT_SUMMARY_DRIFT")
  if (existsSync(path.resolve(repoRoot, LEAN_DIRECT_ACTUAL_FIXTURE_STAGE_DIAGNOSTIC_V4_PATH))) throw new TypeError("LEAN_DIRECT_V13_CONSUMED_DESTINATION_APPEARED")
}
...
export const runLeanActualFixtureStageDiagnosticInjected = (overrides: Partial<LeanActualFixtureDiagnosticDependencies> = {}): Omit<LeanActualFixtureStageDiagnosticV4, "schemaVersion" | "sourceCommit" | "sourceTree" | "executableClosureRoot" | "image" | "controlsRoot" | "history" | "attemptOrdinal" | "attemptLimit" | "attemptsRemaining" | "preflightInvocations" | "matchInvocations" | "authority"> => {
  ...
  diagnostic: for (const fixtureId of LEAN_ACTUAL_FIXTURE_IDS) {
    ...
    try {
      ...
      for (const method of LEAN_ACTUAL_FIXTURE_METHODS) {
        for (let ordinal = 0; ordinal <= 3; ordinal += 1) {
          ...
          let result: ReturnType<LeanContainerMatchSession["adapter"]["execute"]>
          try {
            result = session.adapter.execute({ source, methodName: method, input: buildLeanContainerPreflightProbeInput(method), timeoutMs: 5_000, outputByteLimit: 32_768 })
          } catch {
            resultClass = "session_failure"; violationType = null; break diagnostic
          } finally {
            const elapsed = Number(dependencies.nowNanoseconds() - started) / 1_000_000
            requestTimings.push(finiteNonNegative(elapsed) ? elapsed : 0)
          }
          if (!result.ok) {
            if (LEAN_RUNTIME_VIOLATION_TYPES.includes(result.violation.type)) { resultClass = "player_violation"; violationType = result.violation.type }
            else { resultClass = "session_failure"; violationType = null }
            break diagnostic
          }
          successful += 1
        }
      ...
      resultClass = "session_failure"; violationType = null
      break diagnostic
    } finally {
      if (session !== undefined) {
        const stageBeforeClose = terminalStage
        const failureBeforeClose = resultClass !== null
        try {
          const closed = session.close()
          if (closed.cleanupComplete && !closed.orphanedChild) sessionsClosed += 1
          else { cleanupComplete = false; if (!failureBeforeClose) { terminalStage = `${fixtureId}:session:close`; resultClass = "session_failure"; violationType = null } }
        } catch {
          cleanupComplete = false
          if (!failureBeforeClose) { terminalStage = `${fixtureId}:session:close`; resultClass = "session_failure"; violationType = null }
        }
    ...
    if (resultClass !== null) break diagnostic
  }
...
export const writeLeanActualFixtureStageDiagnosticV4 = (_repoRoot: string): never => { throw new TypeError("LEAN_DIRECT_V13_ATTEMPT_CONSUMED") }
export const checkLeanActualFixtureStageDiagnosticV4 = (repoRoot: string): void => { assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); assertLeanDirectV13Source(repoRoot); assertLeanDirectV13History(repoRoot); assertLeanDirectAttempt7History(repoRoot); assertSuccessorLockInventory(repoRoot) }

const buildLeanActualFixtureStageDiagnosticV5 = (observed: ReturnType<typeof runLeanActualFixtureStageDiagnosticInjected>): LeanActualFixtureStageDiagnosticV5 => ({ schemaVersion: "v1.38-lean-runner-direct-actual-fixture-stage-diagnostic-v5", sourceCommit: LEAN_DIRECT_V13_SOURCE_COMMIT, sourceTree: LEAN_DIRECT_V13_SOURCE_TREE, executableClosureRoot: LEAN_DIRECT_V13_CLOSURE_ROOT, image: LEAN_CONTAINER_IMAGE, controlsRoot: LEAN_DIRECT_V13_CONTROLS_ROOT, history: LEAN_DIRECT_V14_HISTORY, ...observed, attemptOrdinal: 8, attemptLimit: 10, attemptsRemaining: 2, preflightInvocations: 0, matchInvocations: 0, authority: LEAN_AUTHORITY_FALSE })
export const validateLeanActualFixtureStageDiagnosticV5 = (repoRoot: string, value: unknown): LeanActualFixtureStageDiagnosticV5 => {
  assertPrivacySafe(value)
  const keys = ["schemaVersion", "sourceCommit", "sourceTree", "executableClosureRoot", "image", "controlsRoot", "history", "terminalStage", "resultClass", "violationType", "requestCounts", "aggregateTimings", "cleanup", "attemptOrdinal", "attemptLimit", "attemptsRemaining", "preflightInvocations", "matchInvocations", "authority"]
  if (!isObject(value) || !exactKeys(value, keys) || value.schemaVersion !== "v1.38-lean-runner-direct-actual-fixture-stage-diagnostic-v5" || value.sourceCommit !== LEAN_DIRECT_V13_SOURCE_COMMIT || value.sourceTree !== LEAN_DIRECT_V13_SOURCE_TREE || value.executableClosureRoot !== LEAN_DIRECT_V13_CLOSURE_ROOT || value.image !== LEAN_CONTAINER_IMAGE || value.controlsRoot !== LEAN_DIRECT_V13_CONTROLS_ROOT || JSON.stringify(value.history) !== JSON.stringify(LEAN_DIRECT_V14_HISTORY) || !isLeanActualFixtureStage(value.terminalStage) || ![null, "player_violation", "session_failure"].includes(value.resultClass as never) || !(value.violationType === null || LEAN_RUNTIME_VIOLATION_TYPES.includes(value.violationType as never)) || (value.resultClass === "player_violation") !== (value.violationType !== null) || !isObject(value.requestCounts) || !exactKeys(value.requestCounts, ["planned", "attempted", "successful"]) || value.requestCounts.planned !== 16 || !Number.isSafeInteger(value.requestCounts.attempted) || !Number.isSafeInteger(value.requestCounts.successful) || (value.requestCounts.attempted as number) < 0 || (value.requestCounts.attempted as number) > 16 || (value.requestCounts.successful as number) < 0 || (value.requestCounts.successful as number) > (value.requestCounts.attempted as number) || !isObject(value.aggregateTimings) || !exactKeys(value.aggregateTimings, ["requestCount", "totalMilliseconds", "maximumMilliseconds", "lifecycleCount", "lifecycleTotalMilliseconds", "lifecycleMaximumMilliseconds"]) || value.aggregateTimings.requestCount !== value.requestCounts.attempted || !finiteNonNegative(value.aggregateTimings.totalMilliseconds) || !finiteNonNegative(value.aggregateTimings.maximumMilliseconds) || !Number.isSafeInteger(value.aggregateTimings.lifecycleCount) || !finiteNonNegative(value.aggregateTimings.lifecycleTotalMilliseconds) || !finiteNonNegative(value.aggregateTimings.lifecycleMaximumMilliseconds) || !isObject(value.cleanup) || !exactKeys(value.cleanup, ["sessionsExpected", "sessionsClosed", "complete"]) || value.cleanup.sessionsExpected !== 2 || !Number.isSafeInteger(value.cleanup.sessionsClosed) || (value.cleanup.sessionsClosed as number) < 0 || (value.cleanup.sessionsClosed as number) > 2 || typeof value.cleanup.complete !== "boolean" || value.attemptOrdinal !== 8 || value.attemptLimit !== 10 || value.attemptsRemaining !== 2 || value.preflightInvocations !== 0 || value.matchInvocations !== 0 || !exactFalseAuthority(value.authority)) throw new TypeError("LEAN_ACTUAL_FIXTURE_STAGE_DIAGNOSTIC_V5_INVALID")
  if (value.terminalStage === "complete" ? value.requestCounts.attempted !== 16 || value.requestCounts.successful !== 16 || value.cleanup.sessionsClosed !== 2 || value.cleanup.complete !== true || value.resultClass !== null : value.resultClass === null) throw new TypeError("LEAN_ACTUAL_FIXTURE_STAGE_DIAGNOSTIC_V5_DISPOSITION_INVALID")
  assertLeanDirectV13Source(repoRoot); assertLeanDirectV13History(repoRoot); assertLeanDirectAttempt7History(repoRoot)
  return globalThis.structuredClone(value) as unknown as LeanActualFixtureStageDiagnosticV5
}
const assertLeanDirectV14DestinationsFresh = (repoRoot: string): void => {
  assertLeanDirectAttempt7History(repoRoot)
...
const main = (): void => {
  ...
  } else if (selector === "--check-direct-worker-lifecycle-source-only-v10") {
    checkLeanDirectWorkerLifecycleSourceOnlyV10(repoRoot)
  } else if (selector === "--write-direct-worker-lifecycle-diagnostic-v1") {
    writeLeanDirectWorkerLifecycleDiagnosticV1(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-worker-lifecycle-diagnostic-v1") {
    checkLeanDirectWorkerLifecycleDiagnosticV1(repoRoot)
  } else if (selector === "--write-direct-container-preflight-v9") {
    writeLeanContainerPreflightArtifactV9(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-container-preflight-v9") {
    assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); validateLeanContainerPreflightArtifactV9(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.preflight))
  } else if (selector === "--render-direct-authorization-v10") {
    process.stdout.write(`${JSON.stringify(renderLeanDirectAuthorizationV10(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3])), null, 2)}\n`); return
  } else if (selector === "--write-direct-authorization-v10") {
    writeLeanDirectAuthorizationV10(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-authorization-v10") {
    assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); checkLeanDirectAuthorizationV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V10_ARTIFACT_PATHS.authorization))
  } else if (selector === "--check-direct-review-disposition-v10") {
    checkLeanDirectReviewDispositionV10(repoRoot)
  } else if (selector === "--check-direct-reviewed-ready-v10") {
    loadAndCheckLeanDirectReviewedReadyV10(repoRoot)
  } else if (selector === "--check-direct-post-run-v10") {
    checkLeanDirectPostRunV10(repoRoot)
  } else if (selector === "--write-direct-adjudication-v10") {
    writeLeanDirectAdjudicationAndEligibilityV10(repoRoot)
  } else if (selector === "--check-direct-adjudication-v10") {
    checkLeanDirectAdjudicationV10(repoRoot)
  } else if (selector === "--check-direct-final-tracking-v10") {
    checkLeanDirectFinalTrackingV10(repoRoot)
  } else if (selector === "--check-direct-worker-lifecycle-source-only-v11") {
    checkLeanDirectWorkerLifecycleSourceOnlyV11(repoRoot)
  } else if (selector === "--write-direct-worker-lifecycle-diagnostic-v2") {
    writeLeanDirectWorkerLifecycleDiagnosticV2(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-worker-lifecycle-diagnostic-v2") {
    checkLeanDirectWorkerLifecycleDiagnosticV2(repoRoot)
  } else if (selector === "--write-direct-container-preflight-v10") {
    writeLeanContainerPreflightArtifactV10(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-container-preflight-v10") {
    assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); validateLeanContainerPreflightArtifactV10(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.preflight))
  } else if (selector === "--render-direct-authorization-v11") {
    process.stdout.write(`${JSON.stringify(renderLeanDirectAuthorizationV11(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3])), null, 2)}\n`); return
  } else if (selector === "--write-direct-authorization-v11") {
    writeLeanDirectAuthorizationV11(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-authorization-v11") {
    assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); checkLeanDirectAuthorizationV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V11_ARTIFACT_PATHS.authorization))
  } else if (selector === "--check-direct-review-disposition-v11") {
    checkLeanDirectReviewDispositionV11(repoRoot)
  } else if (selector === "--check-direct-reviewed-ready-v11") {
    loadAndCheckLeanDirectReviewedReadyV11(repoRoot)
  } else if (selector === "--check-direct-post-run-v11") {
    checkLeanDirectPostRunV11(repoRoot)
  } else if (selector === "--write-direct-adjudication-v11") {
    writeLeanDirectAdjudicationAndEligibilityV11(repoRoot)
  } else if (selector === "--check-direct-adjudication-v11") {
    checkLeanDirectAdjudicationV11(repoRoot)
  } else if (selector === "--check-direct-final-tracking-v11") {
    checkLeanDirectFinalTrackingV11(repoRoot)
  } else if (selector === "--check-direct-worker-lifecycle-source-only-v12") {
    checkLeanDirectWorkerLifecycleSourceOnlyV12(repoRoot)
  } else if (selector === "--write-direct-worker-lifecycle-diagnostic-v3") {
    writeLeanDirectWorkerLifecycleDiagnosticV3(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-worker-lifecycle-diagnostic-v3") {
    checkLeanDirectWorkerLifecycleDiagnosticV3(repoRoot)
  } else if (selector === "--write-direct-container-preflight-v11") {
    writeLeanContainerPreflightArtifactV11(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-container-preflight-v11") {
    assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); validateLeanContainerPreflightArtifactV11(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.preflight))
  } else if (selector === "--render-direct-authorization-v12") {
    process.stdout.write(`${JSON.stringify(renderLeanDirectAuthorizationV12(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3])), null, 2)}\n`); return
  } else if (selector === "--write-direct-authorization-v12") {
    writeLeanDirectAuthorizationV12(repoRoot, validateLeanDirectV2ExplicitSourceRef(process.argv[3]))
  } else if (selector === "--check-direct-authorization-v12") {
    assertLeanStatus(git(repoRoot, ["status", "--short", "--untracked-files=all"])); checkLeanDirectAuthorizationV12(repoRoot, readJson(repoRoot, LEAN_DIRECT_V12_ARTIFACT_PATHS.authorization))
  } else if (selector === "--check-direct-review-disposition-v12") {
    checkLeanDirectReviewDispositionV12(repoRoot)
  } else if (selector === "--check-direct-reviewed-ready-v12") {
    loadAndCheckLeanDirectReviewedReadyV12(repoRoot)
  } else if (selector === "--check-direct-post-run-v12") {
    checkLeanDirectPostRunV12(repoRoot)
  } else if (selector === "--write-direct-adjudication-v12") {
    writeLeanDirectAdjudicationAndEligibilityV12(repoRoot)
  } else if (selector === "--check-direct-adjudication-v12") {
  ...
  } else if (selector === "--check-direct-actual-fixture-source-only-v14") {
    checkLeanDirectActualFixtureSourceOnlyV14(repoRoot)
  } else if (selector === "--write-direct-actual-fixture-stage-diagnostic-v5") {
