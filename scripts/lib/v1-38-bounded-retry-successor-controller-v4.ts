...
const nativeSource = path.resolve(
  sourceDirectory,
  "../native/v1-38-successor-transaction-helper-v4.c",
)
...
export const V138_SUCCESSOR_CONTROLLER_V4_CLI = fileURLToPath(import.meta.url)
export const V138_SUCCESSOR_CONTROLLER_V4_OPERATIONS = Object.freeze([
...
> => {
  const root = mkdtempSync(path.join(tmpdir(), "v138-successor-controller-v4-"))
  try {
...
if (process.argv[1] === V138_SUCCESSOR_CONTROLLER_V4_CLI) {
