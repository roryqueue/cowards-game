...
| --- | --- | --- | --- | --- |
| 222 | Language Surface Inventory | Inventory every current language, runtime, eligibility, product-label, docs, and monitor surface before changing behavior. | INV-01..INV-05 | 5 |
...
| 227 | Zig Production Support Path | Promote Zig through provider validation, no-std/import policy, immutable artifact policy, execution, counted eligibility, and signed-in proof. | ZIG-01..ZIG-05 | 5 |
...
Phase 222: Language Surface Inventory is ready for discussion and planning.
