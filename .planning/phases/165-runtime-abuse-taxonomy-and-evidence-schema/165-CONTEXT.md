# Phase 165: Runtime Abuse Taxonomy and Evidence Schema - Context
...
Build the cross-runtime abuse taxonomy and public-safe evidence format.

This phase clarifies and implements only the requirements mapped to Phase 165: LAB-01, LAB-02, LAB-03, LAB-04, LAB-05, LAB-06. New runtime promotion, counted non-JS support, production sandbox certification, or ABI migration outside this phase boundary must be deferred unless explicitly required by the mapped requirements.
...
### Approved Defaults
- **D-01:** Organize probes by abuse behavior first and runtime lane second.
- **D-02:** Produce machine-readable JSON plus public-safe Markdown for human audit.
- **D-03:** Evidence must record runtime lane, probe class, expected outcome, observed outcome, failure class, privacy class, and promotion impact.
- **D-04:** Unsupported or unavailable lanes fail loud as non-proof; they must not count as sandbox passes.
- **D-05:** Evidence must distinguish Strategy failure from system failure and remain rerunnable locally without production credentials.
