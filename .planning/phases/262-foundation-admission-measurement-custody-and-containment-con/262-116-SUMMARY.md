...
- Final review isolated the remaining v3 failure to `localExecutionClosureRoot`: all nine observations and both replay roots already matched, but rerender compared a worktree-specific path/device/inode root. RED `d629a0f0` captures this exact failure.
- Fix `9713e513` removes ambient runtime/platform and checkout-local identity from portable publication evidence while retaining independent current local-custody checks. Exact-three-add v4 publication `f03f0e05539a1591b91000fc9d35b8381a082ec2` has payload/review/carrier roots `sha256:251b01b973f1abde239089e6e49dc6c38c74803a273fa6f104a6cdda156de1d7`, `sha256:d238645459920ba74d9e8265f5b0c0609e636f86d027a2e7f473058f746aedf3`, and `sha256:3d665d7f562b575a9b2ffdeafbe1458922e2687bd75b32027b39cb67c0a7632b`.
- Canonical authentication and regression `65b05d23` pass after unrelated post-publication commits. V1-v3 remain immutable/ineligible; v4 alone grants revised Plan-109 eligibility. Blocked lifecycle behavior and every no-effect boundary remain unchanged.
