...
must_haves:
  ...
  key_links:
    - from: .planning/artifacts/v1.38-successor-source-seal-v7.json
      ...
      via: "Exact A7/B7 authority, main-only ownership, fresh-destination check, and one atomic publication binding context:v11 plus preflight consumption"
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    1. Confirm the checker reports exact A7/B7, zero findings, clean main ownership, zero active helpers/executors, and the complete route-start/receipt/marker/terminal destination set absent.
