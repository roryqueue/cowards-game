...
| 262-G4 | 262-11 | 6 | ADMIT-03 | T-262-45 | Real sampler denial/cleanup proof, explicit sampler authorization, immutable v2/v3 successor lineage, and fresh exact reproduction | real process + mutation + integration | `pnpm exec vitest run scripts/evaluate-v1-38-foundation-contract.test.ts -t "matrix real process boundary\|matrix sampler denial\|matrix real cleanup proof\|matrix successor lineage\|matrix calibration v2 branches\|matrix authoritative v3 receipt"` plus authorized v2/v3 checkers | ✅ | ⬜ pending authorization |
