# Phase 166: JS/TS and Python Runtime Abuse Probes - Context
...
### Approved Defaults
- **D-01:** Extend the existing sandbox evaluation style instead of inventing a parallel harness.
- **D-02:** JS/TS counted behavior must remain regression-protected while abuse probes are added.
- **D-03:** Python remains non-counted exhibition beta and must never fall back to JS/TS, Go/source execution, or stale artifacts.
- **D-04:** Probe timeout, oversized output, malformed result, invalid schema/action, thrown/crash behavior, runtime unavailability, and forbidden capabilities where applicable.
- **D-05:** Keep evidence public-safe and eligibility-aware.
