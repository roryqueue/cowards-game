# Phase 264: Immutable Factory, Independent Oracles, and Quarantined Intake - Discussion Log
...
**Areas discussed:** Milestone-wide carry-forward charter; private candidate repository; clone evidence; independent automated cores; model bundles; human/external quarantine
...
- Exact clone/correlation thresholds only after the required development-only calibration spike and before league admission.

## Deferred Ideas

- League solving, finalist selection, formation work, sealed evaluation, and production/public features remain outside Phase 264.
