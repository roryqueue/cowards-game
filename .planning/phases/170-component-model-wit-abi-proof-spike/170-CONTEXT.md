# Phase 170: Component Model/WIT ABI Proof Spike - Context
...
This phase clarifies and implements only the requirements mapped to Phase 170: WIT-01, WIT-02, WIT-03, WIT-04, WIT-05, WIT-06. New runtime promotion, counted non-JS support, production sandbox certification, or ABI migration outside this phase boundary must be deferred unless explicitly required by the mapped requirements.
...
### Approved Defaults
- **D-01:** Define a minimal Strategy WIT world/interface and record generated binding/tooling status.
- **D-02:** Rust proof has priority if tooling parity gets tight, but Zig non-parity must be recorded honestly.
- **D-03:** Record Wasmtime host integration, import surface, timeout/fuel, memory, result cap, validation, trap handling, and privacy behavior.
- **D-04:** Component Model/WIT artifacts must be ineligible for Match execution without a future explicit promotion decision.
- **D-05:** No hidden Match execution path is allowed.
