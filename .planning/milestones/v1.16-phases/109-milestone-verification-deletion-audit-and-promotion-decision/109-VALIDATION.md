...
- **EXIT-04:** PASS. v1.16 roadmap, requirements, phases, and audit were archived; active `.planning/REQUIREMENTS.md` was removed for the next milestone cycle; project state files were updated; tag `v1.16` is created as the archival marker.
