# Phase 184: Retry and Non-Retry Lifecycle Semantics in Go Orchestration - Plan
...
1. Add Go-owned failure classification helper and table tests.
2. Thread classification into job failure recording and public-safe terminal Match fields.
3. Keep retry loops bounded by existing max-attempt logic.
