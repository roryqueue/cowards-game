# Phase 167 Research: WASM/WASI Rust/Zig Abuse Probes
...
- Rust and Zig Preview 1 JSON probes execute, validation blocks forbidden surfaces, and stale/missing/ABI-mismatched artifact metadata fails closed.
