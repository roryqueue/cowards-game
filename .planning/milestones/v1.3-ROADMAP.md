...
Competition Trust Beta shipped a resettable trial ladder with credible starter Strategies, deterministic scheduling and standings, public player/Strategy identity surfaces, focused result governance, and a production-candidate containerized subprocess runtime boundary.
...
**Current milestone:** v1.3 Competition Trust Beta (shipped)
