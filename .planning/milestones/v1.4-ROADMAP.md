...
v1.4 corrected Coward's Game's core timing contract from full-Activation sequencing to Cycle-interleaved selected slots. It published the corrected rule source of truth, rewrote the pure engine scheduler, rebaselined Chronicle/replay compatibility, refreshed starter Strategies, generated a completed v1.4 demo ladder, and added faster replay playback controls for dense Cycle timelines.
