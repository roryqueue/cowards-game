...
Trustworthy Simulation Beta sharpened trust in Coward's Game simulation: legal replay fixtures, strict Chronicle grammar, hardened runtime isolation boundaries, owner/debug doctrine UX, repeatable local/CI startup, and persisted owner replay debug authorization.
