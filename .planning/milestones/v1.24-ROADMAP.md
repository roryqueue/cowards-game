...
Shipped 2026-05-30. v1.24 delivered runtime abuse evidence, a production-sandbox readiness matrix, ABI future-path non-promotion spikes, live signed-in regression proof, and calibrated final decisions preserving JS/TS counted support, non-JS exhibition beta status, Preview 1 JSON ABI, Go ownership, runtime-service hostile execution boundaries, and public-output privacy.
