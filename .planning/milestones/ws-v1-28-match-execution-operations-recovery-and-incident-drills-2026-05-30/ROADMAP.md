...
| 208 | End-to-End Signed-In Operations Recovery Proof | Run signed-in local proof across counted JS/TS, beta regression lanes where available, operator recovery, public pages, and privacy scans. | E2E-01..E2E-06 | Complete |
| 209 | Audit, Archive, Commit, and Tag | Review, validate, archive, commit, and tag v1.28. | CLOSE-01..CLOSE-05 | Complete |
...
v1.28 closeout complete. Start the next milestone with `$gsd-new-milestone`.
