...
- TinyGo imports may require host capabilities incompatible with the current WASI posture.
...
- Treat TinyGo as an evidence artifact and recommendation, not a product language.
