...
- TinyGo produces spike evidence: compile viability, ABI compatibility, import audit, size/latency notes, deterministic behavior checks, failure taxonomy, and recommendation.
...
- The spike recommendation includes enough operational evidence to decide whether TinyGo deserves a future production support milestone.
...
- Enabling TinyGo in counted play during spike work.
