...
- Wasmtime/WASI tooling and import-table probes from the Rust/Zig lanes should be reused for the TinyGo spike.
...
- No production TinyGo provider unless explicitly approved later.
