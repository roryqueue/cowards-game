...
describe("Python counted runtime v1.18 identity", () => {
  ...
  it("keeps prior Python v1.17 host and protocol bytes immutable", () => {
    expect(fileSha256("./python-subprocess-adapter.ts")).toBe(
      "b73b6d5860fdaa3ab6f066b7ca76e709d0f77631d602cfd4014e3c49a7443384",
    )
    expect(fileSha256("./revision-v1-17.test.ts")).toBe(
      "8359841a6ad4809cdf76b5c9b400f100f5bfff10d4403d0f310ef6f6e4c4c235",
    )
    expect(fileSha256("./python_runtime_host.py")).toBe(
