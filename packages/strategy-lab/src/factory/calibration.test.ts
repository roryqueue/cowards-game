...
describe("factory independence calibration contracts", () => {
  ...
  it("accepts only a fresh roots-only authorized manifest with finite bounds", () => {
    const manifest = createFactoryCalibrationManifest({
      authorizationRoot: root("1"), protocolRoot: root("2"), allocationRoot: root("3"),
      ...
      supervision: { adapterId: "runtime-js-container-subprocess", runtimeAbi: "strategy-runtime-abi-v1.19", image: "cowards-runtime-js@sha256:test", runtimeProfileRoot: root("4") },
