...
const keys = ["phase", "privacy", "evidenceClass", "operatorDecision", "studyPolicyRoot", "measurementPolicyRoot", "tupleRoot", "runtimeRoot", "implementationRoot", "initialCandidatePublicationRoots", "factoryAssessmentArtifactRoots", "independenceReferencePublicationRoot", "seedBlocks", "opportunities", "operations", "retryBurn", "channels", "probes", "rounds", "participantPolicy"] as const
