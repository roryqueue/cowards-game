...
export interface LeagueExecutionAllocationInput {
  ...
  readonly initialCandidatePublicationRoots: readonly LabRoot[]; readonly factoryAssessmentArtifactRoots: readonly LabRoot[]; readonly seedBlocks: readonly string[]
...
const keys = ["phase", "privacy", "evidenceClass", "operatorDecision", "studyPolicyRoot", "measurementPolicyRoot", "tupleRoot", "runtimeRoot", "implementationRoot", "initialCandidatePublicationRoots", "factoryAssessmentArtifactRoots", "seedBlocks", "opportunities", "operations", "retryBurn", "channels", "probes", "rounds", "participantPolicy"] as const
